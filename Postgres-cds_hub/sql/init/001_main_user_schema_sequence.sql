...
END IF;
    ...
    IF NOT EXISTS (
        ...
        FROM
            pg_catalog.pg_roles
        WHERE
            rolname = 'db2dataprocessor_user') THEN
...
END IF;
    ...
    IF NOT EXISTS (
        ...
        FROM
            information_schema.schemata
        WHERE
            schema_name = 'db2dataprocessor_out') THEN
...
END IF;
    ...
    IF NOT EXISTS (
        ...
        FROM
            information_schema.schemata
        WHERE
            schema_name = 'db2dataprocessor_in') THEN
...
END IF;
    ...
    IF NOT EXISTS (
        ...
        FROM
            information_schema.schemata
        WHERE
            schema_name = 'db2frontend_out') THEN
...
END IF;
    ...
    IF NOT EXISTS (
        ...
        FROM
            information_schema.schemata
        WHERE
            schema_name = 'db2frontend_in') THEN
...
-- Create Sequenz --------------------------------------------------------------------------------
CREATE SEQUENCE IF NOT EXISTS db.db_seq
INCREMENT 1 START 1;

-- Using a central sequence
