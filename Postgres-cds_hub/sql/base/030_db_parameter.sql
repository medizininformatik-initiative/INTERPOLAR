...
---------------------------------------------------------------------------------------
   ...
   release_version VARCHAR := '1.7.0';              -- GitHup release version
   release_version_nr INT := 170;                   -- version number - first 3 digits as integer for comparison
   release_version_date VARCHAR := '2026-04-14';    -- GitHup (likely) release version date
