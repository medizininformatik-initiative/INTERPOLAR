...
---------------------------------------------------------------------------------------
   ...
   release_version VARCHAR := '1.7.2';              -- GitHup release version
   release_version_nr INT := 172;                   -- version number - first 3 digits as integer for comparison
   release_version_date VARCHAR := '2026-05-11';    -- GitHup (likely) release version date
