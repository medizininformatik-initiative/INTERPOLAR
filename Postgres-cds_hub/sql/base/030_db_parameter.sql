...
---------------------------------------------------------------------------------------
   ...
   release_version VARCHAR := '2.0.0';              -- GitHup release version
   release_version_nr INT := 200;                   -- version number - first 3 digits as integer for comparison
   release_version_date VARCHAR := '2026-06-10';    -- GitHup (likely) release version date
