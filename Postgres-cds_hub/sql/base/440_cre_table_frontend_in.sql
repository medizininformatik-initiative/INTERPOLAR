...
-- Create time: 2026-06-14 22:44:24
...
BEGIN
    IF EXISTS ( -- Table exists
        ...
        FROM (
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'patient_fe') a,
            (
                SELECT
                    1 s
                FROM
        ...
        IF NOT EXISTS ( -- column not exists
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'patient_fe'
                AND column_name = 'input_datetime') THEN
        NULL;
END IF;
    -- column
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'patient_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2frontend_in.patient_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'patient_fe'
            AND column_name = 'last_check_datetime') THEN
        ALTER TABLE db2frontend_in.patient_fe
            ADD last_check_datetime timestamp DEFAULT NULL;
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'patient_fe'
            AND column_name = 'current_dataset_status') THEN
        ALTER TABLE db2frontend_in.patient_fe
            ADD current_dataset_status varchar DEFAULT 'input';
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'patient_fe'
            AND column_name = 'input_processing_nr') THEN
        ALTER TABLE db2frontend_in.patient_fe
            ADD input_processing_nr int;
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'patient_fe'
            AND column_name = 'last_processing_nr') THEN
        ALTER TABLE db2frontend_in.patient_fe
            ADD last_processing_nr int;
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'patient_fe'
            AND column_name = 'raw_already_processed') THEN
        NULL;
END IF;
    -- column
    ...
    IF EXISTS ( -- column exists
        ...
        FROM (
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'patient_fe'
                AND column_name = 'hash_index_col') a,
            (
                SELECT
                    1 s
                FROM
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'fall_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2frontend_in.fall_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
BEGIN
    IF EXISTS ( -- Table exists
        ...
        FROM (
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'medikationsanalyse_fe') a,
            (
                SELECT
                    1 s
                FROM
        ...
        IF NOT EXISTS ( -- column not exists
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'medikationsanalyse_fe'
                AND column_name = 'input_datetime') THEN
        NULL;
END IF;
    -- column
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'medikationsanalyse_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2frontend_in.medikationsanalyse_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
BEGIN
    IF EXISTS ( -- Table exists
        ...
        FROM (
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'mrpdokumentation_validierung_fe') a,
            (
                SELECT
                    1 s
                FROM
        ...
        IF NOT EXISTS ( -- column not exists
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'mrpdokumentation_validierung_fe'
                AND column_name = 'input_datetime') THEN
        NULL;
END IF;
    -- column
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'mrpdokumentation_validierung_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2frontend_in.mrpdokumentation_validierung_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
BEGIN
    IF EXISTS ( -- Table exists
        ...
        FROM (
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'retrolektive_mrpbewertung_fe') a,
            (
                SELECT
                    1 s
                FROM
        ...
        IF NOT EXISTS ( -- column not exists
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'retrolektive_mrpbewertung_fe'
                AND column_name = 'input_datetime') THEN
        NULL;
END IF;
    -- column
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'retrolektive_mrpbewertung_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2frontend_in.retrolektive_mrpbewertung_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
BEGIN
    IF EXISTS ( -- Table exists
        ...
        FROM (
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'risikofaktor_fe') a,
            (
                SELECT
                    1 s
                FROM
        ...
        IF NOT EXISTS ( -- column not exists
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'risikofaktor_fe'
                AND column_name = 'input_datetime') THEN
        NULL;
END IF;
    -- column
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'risikofaktor_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2frontend_in.risikofaktor_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'trigger_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2frontend_in.trigger_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.fall_fe TO db2frontend_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.fall_fe TO db_user;
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.medikationsanalyse_fe TO db2frontend_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.medikationsanalyse_fe TO db_user;
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.mrpdokumentation_validierung_fe TO db2frontend_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.mrpdokumentation_validierung_fe TO db_user;
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.retrolektive_mrpbewertung_fe TO db2frontend_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.retrolektive_mrpbewertung_fe TO db_user;

-- Additional authorizations for testing
GRANT SELECT ON TABLE db2frontend_in.retrolektive_mrpbewertung_fe TO db_log_user;
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.risikofaktor_fe TO db2frontend_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.risikofaktor_fe TO db_user;
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.trigger_fe TO db2frontend_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.trigger_fe TO db_user;
    ...
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- target column
            ...
            WHERE
                table_schema = 'db2frontend_in'
                AND table_name = 'patient_fe'
                AND column_name = 'patient_fe_id') THEN
            IF EXISTS ( -- INDEX available
                ...
                FROM
                    pg_indexes
                WHERE
                    substr(indexname, 1, 63) = substr('idx_patient_fe_id', 1, 63)
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'patient_fe') THEN
                ...
                IF EXISTS ( -- INDEX nicht auf akuellen Stand
                    ...
                    WHERE
                        ...
                        AND schemaname = 'db2frontend_in'
                        AND tablename = 'patient_fe'
                        AND substr(indexname, 1, 63) = substr('idx_patient_fe_id', 1, 63)
                        AND indexdef != 'CREATE INDEX idx_patient_fe_id ON db2frontend_in.patient_fe USING btree (patient_fe_id DESC)') THEN
                    -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_input_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_patient_fe_input_dt ON db2frontend_in.patient_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_input_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_patient_fe_input_pnr ON db2frontend_in.patient_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_last_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_patient_fe_last_dt ON db2frontend_in.patient_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_last_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_patient_fe_last_pnr ON db2frontend_in.patient_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
...
END IF;
    ...
    IF EXISTS ( -- target column
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'patient_fe'
            AND column_name = 'hash_index_col') THEN
        IF EXISTS ( -- INDEX available
            SELECT
                1
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_hash', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_patient_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_patient_fe_input_dt ON db2frontend_in.patient_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
...
END IF;
    ...
    IF EXISTS ( -- target column
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'fall_fe'
            AND column_name = 'fall_fe_id') THEN
        IF EXISTS ( -- INDEX available
            SELECT
                1
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_fall_fe_id', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                SELECT
                    1
                ...
                WHERE
                    schemaname NOT IN ('pg_catalog', 'information_schema')
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_fall_fe_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_fall_fe_id ON db2frontend_in.fall_fe USING btree (fall_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_input_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_fall_fe_input_dt ON db2frontend_in.fall_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_input_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_fall_fe_input_pnr ON db2frontend_in.fall_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_last_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_fall_fe_last_dt ON db2frontend_in.fall_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_last_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_fall_fe_last_pnr ON db2frontend_in.fall_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_hash', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_fall_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_fall_fe_input_dt ON db2frontend_in.fall_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
...
END IF;
    ...
    IF EXISTS ( -- target column
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'medikationsanalyse_fe'
            AND column_name = 'medikationsanalyse_fe_id') THEN
        IF EXISTS ( -- INDEX available
            SELECT
                1
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_medikationsanalyse_fe_id', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                SELECT
                    1
                ...
                WHERE
                    schemaname NOT IN ('pg_catalog', 'information_schema')
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_medikationsanalyse_fe_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_medikationsanalyse_fe_id ON db2frontend_in.medikationsanalyse_fe USING btree (medikationsanalyse_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_input_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_medikationsanalyse_fe_input_dt ON db2frontend_in.medikationsanalyse_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_input_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_medikationsanalyse_fe_input_pnr ON db2frontend_in.medikationsanalyse_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_last_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_medikationsanalyse_fe_last_dt ON db2frontend_in.medikationsanalyse_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_last_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_medikationsanalyse_fe_last_pnr ON db2frontend_in.medikationsanalyse_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_hash', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_medikationsanalyse_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_medikationsanalyse_fe_input_dt ON db2frontend_in.medikationsanalyse_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
...
END IF;
    ...
    IF EXISTS ( -- target column
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'mrpdokumentation_validierung_fe'
            AND column_name = 'mrpdokumentation_validierung_fe_id') THEN
        IF EXISTS ( -- INDEX available
            SELECT
                1
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_mrpdokumentation_validierung_fe_id', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                SELECT
                    1
                ...
                WHERE
                    schemaname NOT IN ('pg_catalog', 'information_schema')
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_mrpdokumentation_validierung_fe_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_mrpdokumentation_validierung_fe_id ON db2frontend_in.mrpdokumentation_validierung_fe USING btree (mrpdokumentation_validierung_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_input_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_mrpdokumentation_validierung_fe_input_dt ON db2frontend_in.mrpdokumentation_validierung_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_input_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_mrpdokumentation_validierung_fe_input_pnr ON db2frontend_in.mrpdokumentation_validierung_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_last_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_mrpdokumentation_validierung_fe_last_dt ON db2frontend_in.mrpdokumentation_validierung_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_last_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_mrpdokumentation_validierung_fe_last_pnr ON db2frontend_in.mrpdokumentation_validierung_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_hash', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_mrpdokumentation_validierung_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_mrpdokumentation_validierung_fe_input_dt ON db2frontend_in.mrpdokumentation_validierung_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
...
END IF;
    ...
    IF EXISTS ( -- target column
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'retrolektive_mrpbewertung_fe'
            AND column_name = 'retrolektive_mrpbewertung_fe_id') THEN
        IF EXISTS ( -- INDEX available
            SELECT
                1
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_retrolektive_mrpbewertung_fe_id', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                SELECT
                    1
                ...
                WHERE
                    schemaname NOT IN ('pg_catalog', 'information_schema')
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_retrolektive_mrpbewertung_fe_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_retrolektive_mrpbewertung_fe_id ON db2frontend_in.retrolektive_mrpbewertung_fe USING btree (retrolektive_mrpbewertung_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_input_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_retrolektive_mrpbewertung_fe_input_dt ON db2frontend_in.retrolektive_mrpbewertung_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_input_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_retrolektive_mrpbewertung_fe_input_pnr ON db2frontend_in.retrolektive_mrpbewertung_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_last_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_retrolektive_mrpbewertung_fe_last_dt ON db2frontend_in.retrolektive_mrpbewertung_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_last_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_retrolektive_mrpbewertung_fe_last_pnr ON db2frontend_in.retrolektive_mrpbewertung_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_hash', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_retrolektive_mrpbewertung_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_retrolektive_mrpbewertung_fe_input_dt ON db2frontend_in.retrolektive_mrpbewertung_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
...
END IF;
    ...
    IF EXISTS ( -- target column
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'risikofaktor_fe'
            AND column_name = 'risikofaktor_fe_id') THEN
        IF EXISTS ( -- INDEX available
            SELECT
                1
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_risikofaktor_fe_id', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                SELECT
                    1
                ...
                WHERE
                    schemaname NOT IN ('pg_catalog', 'information_schema')
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_risikofaktor_fe_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_risikofaktor_fe_id ON db2frontend_in.risikofaktor_fe USING btree (risikofaktor_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_input_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_risikofaktor_fe_input_dt ON db2frontend_in.risikofaktor_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_input_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_risikofaktor_fe_input_pnr ON db2frontend_in.risikofaktor_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_last_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_risikofaktor_fe_last_dt ON db2frontend_in.risikofaktor_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_last_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_risikofaktor_fe_last_pnr ON db2frontend_in.risikofaktor_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_hash', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_risikofaktor_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_risikofaktor_fe_input_dt ON db2frontend_in.risikofaktor_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
...
END IF;
    ...
    IF EXISTS ( -- target column
        ...
        WHERE
            table_schema = 'db2frontend_in'
            AND table_name = 'trigger_fe'
            AND column_name = 'trigger_fe_id') THEN
        IF EXISTS ( -- INDEX available
            SELECT
                1
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_trigger_fe_id', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                SELECT
                    1
                ...
                WHERE
                    schemaname NOT IN ('pg_catalog', 'information_schema')
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_trigger_fe_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_trigger_fe_id ON db2frontend_in.trigger_fe USING btree (trigger_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_input_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_trigger_fe_input_dt ON db2frontend_in.trigger_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_input_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_trigger_fe_input_pnr ON db2frontend_in.trigger_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_last_dt', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_trigger_fe_last_dt ON db2frontend_in.trigger_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_last_pnr', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_trigger_fe_last_pnr ON db2frontend_in.trigger_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_hash', 1, 63)
                AND schemaname = 'db2frontend_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2frontend_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2frontend_in_trigger_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2frontend_in_trigger_fe_input_dt ON db2frontend_in.trigger_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
