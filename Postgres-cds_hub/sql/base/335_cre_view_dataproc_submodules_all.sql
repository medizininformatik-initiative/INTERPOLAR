            ...
            IF EXISTS ( -- do migration
                ...
                IF EXISTS ( -- VIEW exists
                    ...
                    WHERE
                        ...
                        AND table_name = 'v_dp_mrp_calculations') THEN
                    DROP VIEW db2dataprocessor_out.v_dp_mrp_calculations;
            -- first drop the view
        END IF;
    -- DROP VIEW
    ----------------------------
    CREATE OR REPLACE VIEW db2dataprocessor_out.v_dp_mrp_calculations AS (
        SELECT
            *
        FROM
