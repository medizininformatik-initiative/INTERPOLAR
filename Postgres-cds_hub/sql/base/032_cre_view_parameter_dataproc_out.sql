...
-- Create time: 2026-06-12 11:38:05
    ...
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            ...
            WHERE
                ...
                AND table_name = 'v_db_parameter') THEN
            DROP VIEW db2dataprocessor_out.v_db_parameter;
    -- first drop the view
END IF;
    -- DROP VIEW
    ----------------------------
    CREATE OR REPLACE VIEW db2dataprocessor_out.v_db_parameter AS (
        SELECT
            *
        FROM
            db_config.db_parameter
