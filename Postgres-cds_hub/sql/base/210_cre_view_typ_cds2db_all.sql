...
-- SCRIPTNAME:  base/210_cre_view_typ_cds2db_all.sql
        ...
        BEGIN
            IF EXISTS ( -- do migration
                ...
                IF EXISTS ( -- VIEW exists
                    ...
                    DROP VIEW cds2db_out.v_encounter;
            -- first drop the view
        END IF;
    -- DROP VIEW
    ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_patient;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_condition;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_medication;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_medicationrequest;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_medicationadministration;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_medicationstatement;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_observation;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_diagnosticreport;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_servicerequest;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_procedure;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_consent;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_location;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW cds2db_out.v_pids_per_ward;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
