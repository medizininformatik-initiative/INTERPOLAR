...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            ...
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_encounter'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_patient'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_condition'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_medication'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_medicationrequest'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_medicationadministration'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_medicationstatement'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_observation'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_diagnosticreport'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_servicerequest'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_procedure'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_consent'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_location'
        ) THEN
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            SELECT 1 s FROM information_schema.columns 
            WHERE table_schema = 'cds2db_out' AND table_name = 'v_pids_per_ward'
        ) THEN
