...
-- Create time: 2026-06-14 22:44:32
...
-- COPY_FUNC_SCRIPTNAME:  base/600_dp_in_to_db_log.sql
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db_log.retrolektive_mrpbewertung_fe TO db_log_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db_log.retrolektive_mrpbewertung_fe TO db_user;
...
BEGIN
    ...
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_meda_dat_referenz IS 'Referenzdatum der Medikationsanalyse (timestamp)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_meda_dat1 IS 'Datum der retrolektiven Bewertung* (timestamp)';
    ...
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewissheit1 IS 'Bewertung des detektierten MRP* (varchar)';
    ...
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_trigger1_falsch___4 IS '4 - ret_ip_klasse_nieren_insuf (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl1_1___1 IS '1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl1_1___2 IS '2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl1_1___3 IS '3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl1_1___4 IS '4 - Anderer Fehler (bitte näher erläutern) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl1_2___1 IS '1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl1_2___2 IS '2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl1_2___3 IS '3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)';
    ...
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewissheit2 IS 'Bewertung des detektierten MRP* (varchar)';
    ...
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_trigger2_falsch___3 IS '3 - ret_ip_klasse_disease (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_trigger2_falsch___4 IS '4 - ret_ip_klasse_nieren_insuf (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl2_1___1 IS '1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl2_1___2 IS '2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl2_1___3 IS '3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl2_1___4 IS '4 - Anderer Fehler (bitte näher erläutern) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl2_2___1 IS '1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl2_2___2 IS '2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)';
    COMMENT ON COLUMN db_log.retrolektive_mrpbewertung_fe.ret_gewiss_datengrundl2_2___3 IS '3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)';
            ...
            IF EXISTS ( -- INDEX available
                ...
                IF EXISTS ( -- INDEX nicht auf akuellen Stand
                    ...
                    WHERE
                        ...
                        AND indexdef != 'CREATE INDEX idx_patient_fe_id ON db_log.patient_fe USING btree (patient_fe_id DESC)') THEN
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_patient_fe_record_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_patient_fe_record_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_patient_fe_record_id ON db_log.patient_fe USING btree (record_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_patient_fe_rc_re_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_patient_fe_rc_re_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_patient_fe_rc_re_id ON db_log.patient_fe USING btree (redcap_repeat_instance DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_input_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_patient_fe_input_dt ON db_log.patient_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_input_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_patient_fe_input_pnr ON db_log.patient_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_last_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_patient_fe_last_dt ON db_log.patient_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_last_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_patient_fe_last_pnr ON db_log.patient_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_hash', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_patient_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_patient_fe_input_dt ON db_log.patient_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
        ...
        IF EXISTS ( -- INDEX available
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND indexdef != 'CREATE INDEX idx_fall_fe_id ON db_log.fall_fe USING btree (fall_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_fall_fe_record_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_fall_fe_record_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_fall_fe_record_id ON db_log.fall_fe USING btree (record_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_fall_fe_rc_re_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_fall_fe_rc_re_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_fall_fe_rc_re_id ON db_log.fall_fe USING btree (redcap_repeat_instance DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_input_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_fall_fe_input_dt ON db_log.fall_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_input_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_fall_fe_input_pnr ON db_log.fall_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_last_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_fall_fe_last_dt ON db_log.fall_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_last_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_fall_fe_last_pnr ON db_log.fall_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_hash', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_fall_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_fall_fe_input_dt ON db_log.fall_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
        ...
        IF EXISTS ( -- INDEX available
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND indexdef != 'CREATE INDEX idx_medikationsanalyse_fe_id ON db_log.medikationsanalyse_fe USING btree (medikationsanalyse_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_medikationsanalyse_fe_record_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_medikationsanalyse_fe_record_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_medikationsanalyse_fe_record_id ON db_log.medikationsanalyse_fe USING btree (record_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_medikationsanalyse_fe_rc_re_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_medikationsanalyse_fe_rc_re_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_medikationsanalyse_fe_rc_re_id ON db_log.medikationsanalyse_fe USING btree (redcap_repeat_instance DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_input_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_medikationsanalyse_fe_input_dt ON db_log.medikationsanalyse_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_input_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_medikationsanalyse_fe_input_pnr ON db_log.medikationsanalyse_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_last_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_medikationsanalyse_fe_last_dt ON db_log.medikationsanalyse_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_last_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_medikationsanalyse_fe_last_pnr ON db_log.medikationsanalyse_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_hash', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_medikationsanalyse_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_medikationsanalyse_fe_input_dt ON db_log.medikationsanalyse_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
        ...
        IF EXISTS ( -- INDEX available
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND indexdef != 'CREATE INDEX idx_mrpdokumentation_validierung_fe_id ON db_log.mrpdokumentation_validierung_fe USING btree (mrpdokumentation_validierung_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_mrpdokumentation_validierung_fe_record_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_mrpdokumentation_validierung_fe_record_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_mrpdokumentation_validierung_fe_record_id ON db_log.mrpdokumentation_validierung_fe USING btree (record_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_mrpdokumentation_validierung_fe_rc_re_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_mrpdokumentation_validierung_fe_rc_re_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_mrpdokumentation_validierung_fe_rc_re_id ON db_log.mrpdokumentation_validierung_fe USING btree (redcap_repeat_instance DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_input_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_mrpdokumentation_validierung_fe_input_dt ON db_log.mrpdokumentation_validierung_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_input_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_mrpdokumentation_validierung_fe_input_pnr ON db_log.mrpdokumentation_validierung_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_last_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_mrpdokumentation_validierung_fe_last_dt ON db_log.mrpdokumentation_validierung_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_last_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_mrpdokumentation_validierung_fe_last_pnr ON db_log.mrpdokumentation_validierung_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_hash', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_mrpdokumentation_validierung_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_mrpdokumentation_validierung_fe_input_dt ON db_log.mrpdokumentation_validierung_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
        ...
        IF EXISTS ( -- INDEX available
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND indexdef != 'CREATE INDEX idx_retrolektive_mrpbewertung_fe_id ON db_log.retrolektive_mrpbewertung_fe USING btree (retrolektive_mrpbewertung_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_retrolektive_mrpbewertung_fe_record_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_retrolektive_mrpbewertung_fe_record_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_retrolektive_mrpbewertung_fe_record_id ON db_log.retrolektive_mrpbewertung_fe USING btree (record_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_retrolektive_mrpbewertung_fe_rc_re_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_retrolektive_mrpbewertung_fe_rc_re_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_retrolektive_mrpbewertung_fe_rc_re_id ON db_log.retrolektive_mrpbewertung_fe USING btree (redcap_repeat_instance DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_input_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_retrolektive_mrpbewertung_fe_input_dt ON db_log.retrolektive_mrpbewertung_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_input_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_retrolektive_mrpbewertung_fe_input_pnr ON db_log.retrolektive_mrpbewertung_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_last_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_retrolektive_mrpbewertung_fe_last_dt ON db_log.retrolektive_mrpbewertung_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_last_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_retrolektive_mrpbewertung_fe_last_pnr ON db_log.retrolektive_mrpbewertung_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_hash', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_retrolektive_mrpbewertung_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_retrolektive_mrpbewertung_fe_input_dt ON db_log.retrolektive_mrpbewertung_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
        ...
        IF EXISTS ( -- INDEX available
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND indexdef != 'CREATE INDEX idx_risikofaktor_fe_id ON db_log.risikofaktor_fe USING btree (risikofaktor_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_risikofaktor_fe_record_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_risikofaktor_fe_record_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_risikofaktor_fe_record_id ON db_log.risikofaktor_fe USING btree (record_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_risikofaktor_fe_rc_re_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_risikofaktor_fe_rc_re_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_risikofaktor_fe_rc_re_id ON db_log.risikofaktor_fe USING btree (redcap_repeat_instance DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_input_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_risikofaktor_fe_input_dt ON db_log.risikofaktor_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_input_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_risikofaktor_fe_input_pnr ON db_log.risikofaktor_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_last_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_risikofaktor_fe_last_dt ON db_log.risikofaktor_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_last_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_risikofaktor_fe_last_pnr ON db_log.risikofaktor_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_hash', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_risikofaktor_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_risikofaktor_fe_input_dt ON db_log.risikofaktor_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
        ...
        IF EXISTS ( -- INDEX available
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND indexdef != 'CREATE INDEX idx_trigger_fe_id ON db_log.trigger_fe USING btree (trigger_fe_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_trigger_fe_record_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_trigger_fe_record_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_trigger_fe_record_id ON db_log.trigger_fe USING btree (record_id DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_trigger_fe_rc_re_id', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_trigger_fe_rc_re_id', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_trigger_fe_rc_re_id ON db_log.trigger_fe USING btree (redcap_repeat_instance DESC)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_input_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_trigger_fe_input_dt ON db_log.trigger_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_input_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_trigger_fe_input_pnr ON db_log.trigger_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_last_dt', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_trigger_fe_last_dt ON db_log.trigger_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_last_pnr', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_trigger_fe_last_pnr ON db_log.trigger_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_hash', 1, 63)
                AND schemaname = 'db_log'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db_log'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db_log_trigger_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db_log_trigger_fe_input_dt ON db_log.trigger_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
