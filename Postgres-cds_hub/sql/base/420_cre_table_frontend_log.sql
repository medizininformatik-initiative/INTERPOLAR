...
-- Create time: 2026-02-02 13:39:16
...
-- Data-leading columns -------------------------------------------------------------------------
        ...
        IF NOT EXISTS ( -- column not exists (ret_meda_dat_referenz)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_meda_dat_referenz'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_meda_dat_referenz timestamp;   -- Referenzdatum der Medikationsanalyse (timestamp)
        ...
        IF NOT EXISTS ( -- column not exists (ret_meda_dat1)
            ...
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_meda_dat1 timestamp;   -- Datum der retrolektiven Bewertung* (timestamp)
        ...
        IF NOT EXISTS ( -- column not exists (ret_gewissheit1)
            ...
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewissheit1 varchar;   -- Bewertung des detektierten MRP* (varchar)
        ...
        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger1_falsch___1)
            ...
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger1_falsch___1 varchar;   -- 1 - ret_atc1 (varchar)
        END IF; -- column (ret_gewiss_trigger1_falsch___1)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger1_falsch___2)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_trigger1_falsch___2'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger1_falsch___2 varchar;   -- 2 - ret_atc2 (varchar)
        END IF; -- column (ret_gewiss_trigger1_falsch___2)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger1_falsch___3)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_trigger1_falsch___3'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger1_falsch___3 varchar;   -- 3 - ret_ip_klasse_disease (varchar)
        END IF; -- column (ret_gewiss_trigger1_falsch___3)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger1_falsch___4)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_trigger1_falsch___4'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger1_falsch___4 varchar;   -- 4 - ret_ip_klasse_nieren_insuf (varchar)
        END IF; -- column (ret_gewiss_trigger1_falsch___4)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_1___1)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_1___1'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_1___1 varchar;   -- 1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_1___1)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_1___2)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_1___2'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_1___2 varchar;   -- 2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_1___2)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_1___3)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_1___3'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_1___3 varchar;   -- 3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_1___3)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_1___4)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_1___4'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_1___4 varchar;   -- 4 - Anderer Fehler (bitte näher erläutern) (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_1___4)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_2___1)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_2___1'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_2___1 varchar;   -- 1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_2___1)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_2___2)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_2___2'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_2___2 varchar;   -- 2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_2___2)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_2___3)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_2___3'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_2___3 varchar;   -- 3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_2___3)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_2___4)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_2___4'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_2___4 varchar;   -- 4 - Anderer Fehler (bitte näher erläutern) (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_2___4)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_1_oth)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_1_oth'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl1_1_oth varchar;   -- Kommentar (1. Trigger) (varchar)
        END IF; -- column (ret_gewiss_datengrundl1_1_oth)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl1_2_oth)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl1_2_oth'
        ) THEN
        ...
        IF NOT EXISTS ( -- column not exists (ret_gewissheit2)
            ...
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewissheit2 varchar;   -- Bewertung des detektierten MRP* (varchar)
        ...
        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger2_falsch___1)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_trigger2_falsch___1'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger2_falsch___1 varchar;   -- 1 - ret_atc1 (varchar)
        END IF; -- column (ret_gewiss_trigger2_falsch___1)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger2_falsch___2)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_trigger2_falsch___2'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger2_falsch___2 varchar;   -- 2 - ret_atc2 (varchar)
        END IF; -- column (ret_gewiss_trigger2_falsch___2)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger2_falsch___3)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_trigger2_falsch___3'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger2_falsch___3 varchar;   -- 3 - ret_ip_klasse_disease (varchar)
        END IF; -- column (ret_gewiss_trigger2_falsch___3)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_trigger2_falsch___4)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_trigger2_falsch___4'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_trigger2_falsch___4 varchar;   -- 4 - ret_ip_klasse_nieren_insuf (varchar)
        END IF; -- column (ret_gewiss_trigger2_falsch___4)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_1___1)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_1___1'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_1___1 varchar;   -- 1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_1___1)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_1___2)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_1___2'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_1___2 varchar;   -- 2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_1___2)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_1___3)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_1___3'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_1___3 varchar;   -- 3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_1___3)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_1___4)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_1___4'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_1___4 varchar;   -- 4 - Anderer Fehler (bitte näher erläutern) (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_1___4)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_2___1)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_2___1'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_2___1 varchar;   -- 1 - Der Indikator (bzw. alle Indikatoren - falls mehrere) liegt nicht wie in der Kurzbeschreibung angezeigt im EMR vor (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_2___1)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_2___2)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_2___2'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_2___2 varchar;   -- 2 - Indikator/Indikatoren zum Zeitpunkt der Medikationsanalyse nicht gültig (z.B. pausiert - inaktiv - Fehldiagnose) (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_2___2)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_2___3)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_2___3'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_2___3 varchar;   -- 3 - Zusätzliche Informationen nicht berücksichtigt (z.B. aus Briefen - sonstigen Systemen) (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_2___3)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_2___4)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_2___4'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_2___4 varchar;   -- 4 - Anderer Fehler (bitte näher erläutern) (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_2___4)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_1_oth)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_1_oth'
        ) THEN
            ALTER TABLE db_log.retrolektive_mrpbewertung_fe ADD ret_gewiss_datengrundl2_1_oth varchar;   -- Kommentar (1. Trigger) (varchar)
        END IF; -- column (ret_gewiss_datengrundl2_1_oth)

        IF NOT EXISTS ( -- column not exists (ret_gewiss_datengrundl2_2_oth)
            SELECT 1 FROM information_schema.columns WHERE table_schema = 'db_log' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'ret_gewiss_datengrundl2_2_oth'
        ) THEN
