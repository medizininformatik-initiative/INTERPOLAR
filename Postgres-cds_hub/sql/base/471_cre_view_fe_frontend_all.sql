        ...
        BEGIN
            IF EXISTS ( -- do migration
                ...
                IF EXISTS ( -- VIEW exists
                    ...
                    DROP VIEW db2frontend_out.v_patient_fe;
            -- first drop the view
        END IF;
    -- DROP VIEW
    ----------------------------
    CREATE OR REPLACE VIEW db2frontend_out.v_patient_fe AS (
        SELECT
            *
        FROM
            db_log.patient_fe);
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW db2frontend_out.v_fall_fe;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
        CREATE OR REPLACE VIEW db2frontend_out.v_fall_fe AS (
            SELECT
                *
            FROM
                db_log.fall_fe);
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW db2frontend_out.v_medikationsanalyse_fe;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
        CREATE OR REPLACE VIEW db2frontend_out.v_medikationsanalyse_fe AS (
            SELECT
                *
            FROM
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW db2frontend_out.v_mrpdokumentation_validierung_fe;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
        CREATE OR REPLACE VIEW db2frontend_out.v_mrpdokumentation_validierung_fe AS (
            SELECT
                *
            FROM
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW db2frontend_out.v_retrolektive_mrpbewertung_fe;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
        CREATE OR REPLACE VIEW db2frontend_out.v_retrolektive_mrpbewertung_fe AS (
            SELECT
                *
            FROM
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW db2frontend_out.v_risikofaktor_fe;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
        CREATE OR REPLACE VIEW db2frontend_out.v_risikofaktor_fe AS (
            SELECT
                *
            FROM
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                DROP VIEW db2frontend_out.v_trigger_fe;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
        CREATE OR REPLACE VIEW db2frontend_out.v_trigger_fe AS (
            SELECT
                *
            FROM
                db_log.trigger_fe);
