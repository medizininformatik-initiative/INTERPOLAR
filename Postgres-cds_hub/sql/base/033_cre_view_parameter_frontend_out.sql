...
-- SCRIPTNAME:  base/033_cre_view_parameter_frontend_out.sql
...
BEGIN
    IF EXISTS ( -- do migration
        ...
        IF EXISTS ( -- VIEW exists
            ...
            DROP VIEW db2frontend_out.v_db_parameter;
    -- first drop the view
END IF;
    -- DROP VIEW
    ----------------------------
    CREATE OR REPLACE VIEW db2frontend_out.v_db_parameter AS (
        SELECT
            *
        FROM
            db_config.db_parameter
