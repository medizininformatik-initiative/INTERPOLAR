...
-- Create time: 2026-06-14 22:44:17
...
BEGIN
    IF EXISTS ( -- Table exists
        ...
        FROM (
            ...
            WHERE
                table_schema = 'db2dataprocessor_in'
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'patient_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2dataprocessor_in.patient_fe
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'fall_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2dataprocessor_in.fall_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'medikationsanalyse_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2dataprocessor_in.medikationsanalyse_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'mrpdokumentation_validierung_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2dataprocessor_in.mrpdokumentation_validierung_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'retrolektive_mrpbewertung_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2dataprocessor_in.retrolektive_mrpbewertung_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'risikofaktor_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2dataprocessor_in.risikofaktor_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
END IF;
    ...
    IF NOT EXISTS ( -- column not exists
        ...
        WHERE
            ...
            AND table_name = 'trigger_fe'
            AND column_name = 'input_datetime') THEN
        ALTER TABLE db2dataprocessor_in.trigger_fe
            ADD input_datetime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
    -- Time at which data record was created
END IF;
    -- column
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2dataprocessor_in.retrolektive_mrpbewertung_fe TO db2dataprocessor_user;

-- Additional authorizations for testing
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2dataprocessor_in.retrolektive_mrpbewertung_fe TO db_user;

-- Additional authorizations for testing
GRANT SELECT ON TABLE db2dataprocessor_in.retrolektive_mrpbewertung_fe TO db_log_user;
        ...
        IF EXISTS ( -- target column
            ...
            IF EXISTS ( -- INDEX available
                ...
                FROM
                    pg_indexes
                WHERE
                    substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_input_dt', 1, 63)
                    AND schemaname = 'db2dataprocessor_in'
                ...
                IF EXISTS ( -- INDEX nicht auf akuellen Stand
                    ...
                    WHERE
                        ...
                        AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_input_dt', 1, 63)
                        AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_patient_fe_input_dt ON db2dataprocessor_in.patient_fe USING brin (input_datetime)') THEN
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_input_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_patient_fe_input_pnr ON db2dataprocessor_in.patient_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_last_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_patient_fe_last_dt ON db2dataprocessor_in.patient_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_last_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_patient_fe_last_pnr ON db2dataprocessor_in.patient_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_hash', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'patient_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'patient_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_patient_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_patient_fe_input_dt ON db2dataprocessor_in.patient_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_input_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_fall_fe_input_dt ON db2dataprocessor_in.fall_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_input_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_fall_fe_input_pnr ON db2dataprocessor_in.fall_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_last_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_fall_fe_last_dt ON db2dataprocessor_in.fall_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_last_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_fall_fe_last_pnr ON db2dataprocessor_in.fall_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_hash', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'fall_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'fall_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_fall_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_fall_fe_input_dt ON db2dataprocessor_in.fall_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt ON db2dataprocessor_in.medikationsanalyse_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_input_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_medikationsanalyse_fe_input_pnr ON db2dataprocessor_in.medikationsanalyse_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_last_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_medikationsanalyse_fe_last_dt ON db2dataprocessor_in.medikationsanalyse_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_last_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_medikationsanalyse_fe_last_pnr ON db2dataprocessor_in.medikationsanalyse_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_hash', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'medikationsanalyse_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'medikationsanalyse_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_medikationsanalyse_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt ON db2dataprocessor_in.medikationsanalyse_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_pnr ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_dt ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_pnr ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_hash', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'mrpdokumentation_validierung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'mrpdokumentation_validierung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_pnr ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_dt ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_pnr ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_hash', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'retrolektive_mrpbewertung_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'retrolektive_mrpbewertung_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_input_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_risikofaktor_fe_input_dt ON db2dataprocessor_in.risikofaktor_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_input_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_risikofaktor_fe_input_pnr ON db2dataprocessor_in.risikofaktor_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_last_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_risikofaktor_fe_last_dt ON db2dataprocessor_in.risikofaktor_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_last_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_risikofaktor_fe_last_pnr ON db2dataprocessor_in.risikofaktor_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_hash', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'risikofaktor_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'risikofaktor_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_risikofaktor_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_risikofaktor_fe_input_dt ON db2dataprocessor_in.risikofaktor_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_input_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
            ...
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_input_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_trigger_fe_input_dt ON db2dataprocessor_in.trigger_fe USING brin (input_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_input_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_input_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_trigger_fe_input_pnr ON db2dataprocessor_in.trigger_fe USING brin (input_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_last_dt', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_last_dt', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_trigger_fe_last_dt ON db2dataprocessor_in.trigger_fe USING brin (last_check_datetime)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_last_pnr', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_last_pnr', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_trigger_fe_last_pnr ON db2dataprocessor_in.trigger_fe USING brin (last_processing_nr)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
    ...
    IF EXISTS ( -- target column
        ...
        IF EXISTS ( -- INDEX available
            ...
            FROM
                pg_indexes
            WHERE
                substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_hash', 1, 63)
                AND schemaname = 'db2dataprocessor_in'
                AND tablename = 'trigger_fe') THEN
            -- check current status
            IF EXISTS ( -- INDEX nicht auf akuellen Stand
                ...
                WHERE
                    ...
                    AND schemaname = 'db2dataprocessor_in'
                    AND tablename = 'trigger_fe'
                    AND substr(indexname, 1, 63) = substr('idx_db2dataprocessor_in_trigger_fe_hash', 1, 63)
                    AND indexdef != 'CREATE INDEX idx_db2dataprocessor_in_trigger_fe_input_dt ON db2dataprocessor_in.trigger_fe USING btree (hash_index_col)') THEN
                -- Index entspricht nicht aktuellen Stand - deshalb Index löschen und neu anlegen
