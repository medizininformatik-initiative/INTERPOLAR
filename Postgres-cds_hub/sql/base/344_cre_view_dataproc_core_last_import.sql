            ...
            IF EXISTS ( -- do migration
                ...
                IF EXISTS ( -- VIEW exists
                    ...
                    WHERE
                        ...
                        AND table_name = 'v_input_data_files_last_import') THEN
                    DROP VIEW db2dataprocessor_out.v_input_data_files_last_import;
            -- first drop the view
        END IF;
    -- DROP VIEW
    ----------------------------
    ...
    BEGIN
        IF EXISTS ( -- do migration
            ...
            IF EXISTS ( -- VIEW exists
                ...
                WHERE
                    table_schema = 'db2dataprocessor_out'
                    AND table_name = 'v_input_data_files_processed_content_last_import') THEN
                DROP VIEW db2dataprocessor_out.v_input_data_files_processed_content_last_import;
        -- first drop the view
    END IF;
        -- DROP VIEW
        ----------------------------
