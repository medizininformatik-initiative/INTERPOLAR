...
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "\bid\b" "        SELECT 1 FROM pg_indexes where substr(indexname,1,63) = substr('idx_<%TABLE_NAME%>_<%COLUMN_NAME%>',1,63) AND schemaname = '<%OWNER_SCHEMA%>' AND tablename = '<%TABLE_NAME%>'"%>
...
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "\bid\b" "        ALTER INDEX <%OWNER_SCHEMA%>.idx_<%TABLE_NAME%>_<%COLUMN_NAME%> RENAME TO del_<%TABLE_NAME%>_<%COLUMN_NAME%>;"%>
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "\bid\b" "	    DROP INDEX IF EXISTS <%OWNER_SCHEMA%>.del_<%TABLE_NAME%>_<%COLUMN_NAME%>;"%>
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "\bid\b" "	    CREATE INDEX idx_<%TABLE_NAME%>_<%COLUMN_NAME%> ON <%OWNER_SCHEMA%>.<%TABLE_NAME%> USING btree (<%COLUMN_NAME%>);"%>
...
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "\bid\b" ""%>
...
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "^meta/" "    IF EXISTS ( -- INDEX available"%>
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "^meta/" "        SELECT 1 FROM pg_indexes where substr(indexname,1,63) = substr('idx_<%TABLE_NAME%>_<%COLUMN_NAME%>',1,63) AND schemaname = '<%OWNER_SCHEMA%>' AND tablename = '<%TABLE_NAME%>'"%>
...
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "^meta/" "        ALTER INDEX <%OWNER_SCHEMA%>.idx_<%TABLE_NAME%>_<%COLUMN_NAME%> RENAME TO del_<%TABLE_NAME%>_<%COLUMN_NAME%>;"%>
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "^meta/" "	    DROP INDEX IF EXISTS <%OWNER_SCHEMA%>.del_<%TABLE_NAME%>_<%COLUMN_NAME%>;"%>
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "^meta/" "	    CREATE INDEX idx_<%TABLE_NAME%>_<%COLUMN_NAME%> ON <%OWNER_SCHEMA%>.<%TABLE_NAME%> USING btree (<%COLUMN_NAME%>);"%>
...
<%IF TABLE_DESCRIPTION:COLUMN_DESCRIPTION "^meta/" ""%>
