...
### 330_cre_table_datap_submodules_dataproc_in
...
### 331_cre_table_datap_submodules_log
...
Erstellt die Überführungsfunktion (db.copy_submodules_dp_in_to_db_log) für die berechneten Daten der Submodule des Dataprocessorsaus dem Schnittstellenschema db2dataprocessor_in in den Kern (db_log).
...
### 340_cre_table_datap_core_dataproc_in
ToDo

### 341_cre_table_datap_core_log
ToDo
