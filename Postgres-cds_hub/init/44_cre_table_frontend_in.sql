...
-- Table "patient_fe" in schema "db2frontend_in"
----------------------------------------------------
ALTER TABLE db2frontend_in.patient_fe ALTER COLUMN patient_fe_id SET DEFAULT (nextval('db.db_seq'));
...
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.patient_fe TO db2dataprocessor_user; -- Additional authorizations for testing
...
-- Table "fall_fe" in schema "db2frontend_in"
----------------------------------------------------
ALTER TABLE db2frontend_in.fall_fe ALTER COLUMN fall_fe_id SET DEFAULT (nextval('db.db_seq'));

GRANT TRIGGER ON db2frontend_in.fall_fe TO db2frontend_user;
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db.db_seq TO db2frontend_user;

GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.fall_fe TO db2dataprocessor_user; -- Additional authorizations for testing
...
-- Table "medikationsanalyse_fe" in schema "db2frontend_in"
----------------------------------------------------
ALTER TABLE db2frontend_in.medikationsanalyse_fe ALTER COLUMN medikationsanalyse_fe_id SET DEFAULT (nextval('db.db_seq'));

GRANT TRIGGER ON db2frontend_in.medikationsanalyse_fe TO db2frontend_user;
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db.db_seq TO db2frontend_user;

GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.medikationsanalyse_fe TO db2dataprocessor_user; -- Additional authorizations for testing
...
-- Table "mrpdokumentation_validierung_fe" in schema "db2frontend_in"
----------------------------------------------------
ALTER TABLE db2frontend_in.mrpdokumentation_validierung_fe ALTER COLUMN mrpdokumentation_validierung_fe_id SET DEFAULT (nextval('db.db_seq'));

GRANT TRIGGER ON db2frontend_in.mrpdokumentation_validierung_fe TO db2frontend_user;
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db.db_seq TO db2frontend_user;

GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.mrpdokumentation_validierung_fe TO db2dataprocessor_user; -- Additional authorizations for testing
...
-- Table "risikofaktor_fe" in schema "db2frontend_in"
----------------------------------------------------
ALTER TABLE db2frontend_in.risikofaktor_fe ALTER COLUMN risikofaktor_fe_id SET DEFAULT (nextval('db.db_seq'));

GRANT TRIGGER ON db2frontend_in.risikofaktor_fe TO db2frontend_user;
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db.db_seq TO db2frontend_user;

GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.risikofaktor_fe TO db2dataprocessor_user; -- Additional authorizations for testing
...
-- Table "trigger_fe" in schema "db2frontend_in"
----------------------------------------------------
ALTER TABLE db2frontend_in.trigger_fe ALTER COLUMN trigger_fe_id SET DEFAULT (nextval('db.db_seq'));

GRANT TRIGGER ON db2frontend_in.trigger_fe TO db2frontend_user;
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db.db_seq TO db2frontend_user;

GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE db2frontend_in.trigger_fe TO db2dataprocessor_user; -- Additional authorizations for testing
...
comment on column db2frontend_in.fall_fe.fall_typ_id is 'Datenbank-FK des getypten Falls zur Datenflussverfolgung (Fall: v_fall_all . fall_id) (int)';
...
comment on column db2frontend_in.medikationsanalyse_fe.fall_typ_id is 'Datenbank-FK des Falls (Fall: v_fall_all . fall_id) -> Dataprocessor setzt id: meda_dat in [fall_aufn_dat;fall_ent_dat] (int)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_fall_id is 'Fall-ID zu dem Medikationsanalyse gehört FHIR (Fall:fall_id) (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.record_id is 'Record ID RedCap - besetzt/vorgegeben mit Datenbankinternen ID des Patienten - wird im Redcap in allen Instanzen  des Patienten verwendet (int)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.meda_typ_id is 'Datenbank-FK der Medikationsanalyse (Medikationsanalyse: medikationsanalyse_fe_id) -> Dataprocessor setzt id: mrp_entd_dat(Tag)=meda_dat(Tag) (int)';
