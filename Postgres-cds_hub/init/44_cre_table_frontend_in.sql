...
COMMENT ON COLUMN db2frontend_in.retrolektive_mrpbewertung_fe.ret_gewissheit_oth1 IS 'Weitere Informationen (varchar)';
COMMENT ON COLUMN db2frontend_in.retrolektive_mrpbewertung_fe.ret_gewiss_grund_abl1 IS 'Grund für nicht Bestätigung (varchar)';
