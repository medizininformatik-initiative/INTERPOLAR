...
-- Create time: 2024-09-02 14:31:48
...
comment on column db2frontend_in.patient_fe.pat_femb is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.fall_fe.fall_femb_5 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.fall_fe.fall_femb_6 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.fall_fe.fall_schwanger_mo_lbl is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.medikationsanalyse_fe.meda_header is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_femb is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_femb_2 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_femb_3 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_femb_4 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_femb_5 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.medikationsanalyse_fe.meda_ma_thueberw_comp is 'Wiedervorlage abgeschlossen? 1, Ja|0, Nein (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_ma_thueberw_comp_dat_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_ma_thueberw_comp_dat is 'Abgeschlossen am (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_mrp_detekt is 'MRP detektiert? 1, Ja|0, Nein (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_aufwand_zeit is '0, <= 5 min | 1, 6-10 min | 2, 11-20 min | 3, 21-30 min | 4, >30 min | 5, Angabe abgelehntZeitaufwand Medikationsanalyse [Min] (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_aufwand_zeit_and_lbl is 'descriptive item only for frontend (int)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_aufwand_zeit_and is 'wie lange hat die Medikationsanalyse gedauert? Eingabe in Minuten.  (int)';
comment on column db2frontend_in.medikationsanalyse_fe.meda_notiz is 'Notizfeld (varchar)';
comment on column db2frontend_in.medikationsanalyse_fe.medikationsanalyse_complete is 'Frontend Complete-Status (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_header is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_5 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_6 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_gewissheit is 'Sicherheit des detektierten MRP (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_gewiss_grund_abl is 'Grund für nicht Bestätigung (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_7 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_8 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_9 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_10 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_11 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_12 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_wirkstoff is 'Wirkstoff betroffen? (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc1_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc1 is '1. Medikament ATC / Name: (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc2_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc2 is '2. Medikament ATC / Name (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc3_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc3 is '3. Medikament ATC / Name (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc4_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc4 is '4. Medikament ATC / Name (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc5_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_atc5 is '5. Medikament ATC / Name (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_13 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_med_prod is 'Medizinprodukt betroffen? (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_med_prod_sonst_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_med_prod_sonst is 'Sonstigespräparat (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_dokup_fehler is 'Fehlerbeschreibung  (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_14 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_15 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_16 is 'descriptive item only for frontend (varchar)';
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_17 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_18 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_19 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrp_femb_20 is 'descriptive item only for frontend (varchar)';
...
comment on column db2frontend_in.mrpdokumentation_validierung_fe.mrpdokumentation_validierung_complete is 'Frontend Complete-Status, wenn ein Pflichtitem fehlt Status bei Import wieder auf Incomplete setzen  (varchar)';
...
comment on column db2frontend_in.risikofaktor_fe.patient_id_fk is 'Datenbank-FK des Patienten (Patient: patient_fe_id=Patient.record_id) (varchar)';
...
comment on column db2frontend_in.trigger_fe.patient_id_fk is 'Datenbank-FK des Patienten (Patient: patient_fe_id=Patient.record_id) (varchar)';
comment on column db2frontend_in.trigger_fe.record_id is 'Record ID RedCap - besetzt/vorgegeben mit Datenbankinternen ID des Patienten - wird im Redcap in allen Instanzen  des Patienten verwendet (int)';
