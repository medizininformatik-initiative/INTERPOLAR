...
-- Create time: 2025-02-21 10:04:55
-- TABLE_DESCRIPTION:  ./R-cds2db/cds2db/inst/extdata/Table_Description.xlsx[table_description]
-- SCRIPTNAME:  23_cre_view_raw_dataproc_last_version.sql
-- TEMPLATE:  template_cre_view6.sql
...
GRANT SELECT ON TABLE db2dataprocessor_out.v_pids_per_ward_raw_last_version TO db2dataprocessor_user;
GRANT USAGE ON SCHEMA db2dataprocessor_out TO db2dataprocessor_user;
