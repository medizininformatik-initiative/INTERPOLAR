...
---------------------------------------------------------------------------------------
   ...
   release_version VARCHAR := '1.4.2';              -- GitHup release version
   release_version_nr INT := 142;                   -- version number - first 3 digits as integer for comparison
   release_version_date VARCHAR := '2025-12-08';    -- GitHup (likely) release version date
