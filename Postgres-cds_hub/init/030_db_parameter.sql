...
---------------------------------------------------------------------------------------
   ...
   release_version VARCHAR := '1.3.0';              -- GitHup release version
   release_version_nr INT := 130;                   -- version number - first 3 digits as integer for comparison
   release_version_date VARCHAR := '2025-10-16';    -- GitHup (likely) release version date
