...
CREATE OR REPLACE TRIGGER patient_fe_tr_ins
  ...
  FOR EACH ROW
  EXECUTE PROCEDURE db2frontend_in.patient_fe_ins_fkt();-- db2frontend_in.fall_fe
------------------------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE TRIGGER fall_fe_tr_ins
  ...
  FOR EACH ROW
  EXECUTE PROCEDURE db2frontend_in.fall_fe_ins_fkt();-- db2frontend_in.medikationsanalyse_fe
------------------------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE TRIGGER medikationsanalyse_fe_tr_ins
  ...
  FOR EACH ROW
  EXECUTE PROCEDURE db2frontend_in.medikationsanalyse_fe_ins_fkt();-- db2frontend_in.mrpdokumentation_validierung_fe
------------------------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE TRIGGER mrpdokumentation_validierung_fe_tr_ins
  ...
  FOR EACH ROW
  EXECUTE PROCEDURE db2frontend_in.mrpdokumentation_validierung_fe_ins_fkt();-- db2frontend_in.retrolektive_mrpbewertung_fe
------------------------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE TRIGGER retrolektive_mrpbewertung_fe_tr_ins
  ...
  FOR EACH ROW
  EXECUTE PROCEDURE db2frontend_in.retrolektive_mrpbewertung_fe_ins_fkt();-- db2frontend_in.risikofaktor_fe
------------------------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE TRIGGER risikofaktor_fe_tr_ins
  ...
  FOR EACH ROW
  EXECUTE PROCEDURE db2frontend_in.risikofaktor_fe_ins_fkt();-- db2frontend_in.trigger_fe
------------------------------------------------------------------------------------------------------------------
