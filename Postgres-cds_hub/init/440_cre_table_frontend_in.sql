...
-- Create time: 2025-03-17 14:58:30
...
COMMENT ON COLUMN db2frontend_in.fall_fe.fall_id IS 'Fall-ID (varchar)';
...
COMMENT ON COLUMN db2frontend_in.medikationsanalyse_fe.fall_meda_id IS 'Dynamische SQL-Abfrage zur Zuordnung Medikationsanalyse -> Fall (varchar)';
COMMENT ON COLUMN db2frontend_in.medikationsanalyse_fe.meda_id IS 'ID Medikationsanalyse (varchar)';
...
COMMENT ON COLUMN db2frontend_in.mrpdokumentation_validierung_fe.mrp_meda_id IS 'Dynamische SQL-Abfrage zur Zuordnung Medikationsanalyse -> MRP (varchar)';
COMMENT ON COLUMN db2frontend_in.mrpdokumentation_validierung_fe.mrp_id IS 'MRP-ID (varchar)';
...
COMMENT ON COLUMN db2frontend_in.retrolektive_mrpbewertung_fe.ret_id IS 'Retrolektive MRP-ID (varchar)';
