...
BEGIN
    ...
    IF status in ('WaitForCronJob') THEN
        ...
        FOR current_record IN (SELECT DISTINCT cal_schema, cal_resource, cal_fhir_column, cal_fhir_id, cal_calculated_column_name, cal_calculated_value, cal_theme FROM cds2db_in.temp_calculated_items) LOOP
