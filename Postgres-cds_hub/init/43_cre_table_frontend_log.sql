...
-- Create time: 2025-01-29 18:36:02
...
-- Index idx_patient_fe_data for Table "patient_fe" in schema "db_log"
----------------------------------------------------
...
-- Index idx_fall_fe_data for Table "fall_fe" in schema "db_log"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_medikationsanalyse_fe_data for Table "medikationsanalyse_fe" in schema "db_log"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_mrpdokumentation_validierung_fe_data for Table "mrpdokumentation_validierung_fe" in schema "db_log"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_risikofaktor_fe_data for Table "risikofaktor_fe" in schema "db_log"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_trigger_fe_data for Table "trigger_fe" in schema "db_log"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
