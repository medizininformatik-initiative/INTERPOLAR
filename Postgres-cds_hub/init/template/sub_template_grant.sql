...
-- Schleife
GRANT INSERT, DELETE, UPDATE, SELECT ON TABLE <%GRANT_SCHEMA_NAME%>.<%GRANT_TABLE_NAME%> TO <%GRANT_TRAGET_USER%>; -- Additional authorizations for testing
