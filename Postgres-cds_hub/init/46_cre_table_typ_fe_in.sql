...
ALTER TABLE db2frontend_in.patient_fe ALTER COLUMN patient_fe_id SET DEFAULT (nextval('db2frontend_in.db2dataprocessor_in_seq'));
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db2frontend_in.db2dataprocessor_in_seq TO db2frontend_user;
...
GRANT SELECT ON TABLE db2frontend_in.fall_fe TO db2frontend_user;
GRANT SELECT ON TABLE db2frontend_in.fall_fe TO db_log_user;
GRANT TRIGGER ON db2frontend_in.fall_fe TO db2frontend_user;
ALTER TABLE db2frontend_in.fall_fe ALTER COLUMN fall_fe_id SET DEFAULT (nextval('db2frontend_in.db2dataprocessor_in_seq'));
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db2frontend_in.db2dataprocessor_in_seq TO db2frontend_user;
...
GRANT SELECT ON TABLE db2frontend_in.medikationsanalyse_fe TO db2frontend_user;
...
ALTER TABLE db2frontend_in.medikationsanalyse_fe ALTER COLUMN medikationsanalyse_fe_id SET DEFAULT (nextval('db2frontend_in.db2dataprocessor_in_seq'));
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db2frontend_in.db2dataprocessor_in_seq TO db2frontend_user;
...
GRANT SELECT ON TABLE db2frontend_in.mrpdokumentation_validierung_fe TO db2frontend_user;
...
ALTER TABLE db2frontend_in.mrpdokumentation_validierung_fe ALTER COLUMN mrpdokumentation_validierung_fe_id SET DEFAULT (nextval('db2frontend_in.db2dataprocessor_in_seq'));
GRANT USAGE ON SCHEMA db2frontend_in TO db2frontend_user;
GRANT USAGE ON db2frontend_in.db2dataprocessor_in_seq TO db2frontend_user;
