...
-- Create time: 2025-04-02 15:40:30
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.encounter_raw)
			    ...
			    err_section:='encounter_raw-37';    err_schema:='cds2db_in';    err_table:='encounter_raw';
                                                        UPDATE db_log.encounter_raw target_record SET enc_meta_versionid = current_record.enc_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND enc_meta_versionid != current_record.enc_meta_versionid;
                            UPDATE db_log.encounter_raw target_record SET enc_meta_lastupdated = current_record.enc_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND enc_meta_lastupdated != current_record.enc_meta_lastupdated;
                            UPDATE db_log.encounter_raw target_record SET enc_meta_profile = current_record.enc_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND enc_meta_profile != current_record.enc_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.patient_raw)
			    ...
			    err_section:='patient_raw-37';    err_schema:='cds2db_in';    err_table:='patient_raw';
                                                        UPDATE db_log.patient_raw target_record SET pat_meta_versionid = current_record.pat_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND pat_meta_versionid != current_record.pat_meta_versionid;
                            UPDATE db_log.patient_raw target_record SET pat_meta_lastupdated = current_record.pat_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND pat_meta_lastupdated != current_record.pat_meta_lastupdated;
                            UPDATE db_log.patient_raw target_record SET pat_meta_profile = current_record.pat_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND pat_meta_profile != current_record.pat_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.condition_raw)
			    ...
			    err_section:='condition_raw-37';    err_schema:='cds2db_in';    err_table:='condition_raw';
                                                        UPDATE db_log.condition_raw target_record SET con_meta_versionid = current_record.con_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND con_meta_versionid != current_record.con_meta_versionid;
                            UPDATE db_log.condition_raw target_record SET con_meta_lastupdated = current_record.con_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND con_meta_lastupdated != current_record.con_meta_lastupdated;
                            UPDATE db_log.condition_raw target_record SET con_meta_profile = current_record.con_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND con_meta_profile != current_record.con_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medication_raw)
			    ...
			    err_section:='medication_raw-37';    err_schema:='cds2db_in';    err_table:='medication_raw';
                                                        UPDATE db_log.medication_raw target_record SET med_meta_versionid = current_record.med_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND med_meta_versionid != current_record.med_meta_versionid;
                            UPDATE db_log.medication_raw target_record SET med_meta_lastupdated = current_record.med_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND med_meta_lastupdated != current_record.med_meta_lastupdated;
                            UPDATE db_log.medication_raw target_record SET med_meta_profile = current_record.med_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND med_meta_profile != current_record.med_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medicationrequest_raw)
			    ...
			    err_section:='medicationrequest_raw-37';    err_schema:='cds2db_in';    err_table:='medicationrequest_raw';
                                                        UPDATE db_log.medicationrequest_raw target_record SET medreq_meta_versionid = current_record.medreq_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND medreq_meta_versionid != current_record.medreq_meta_versionid;
                            UPDATE db_log.medicationrequest_raw target_record SET medreq_meta_lastupdated = current_record.medreq_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND medreq_meta_lastupdated != current_record.medreq_meta_lastupdated;
                            UPDATE db_log.medicationrequest_raw target_record SET medreq_meta_profile = current_record.medreq_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND medreq_meta_profile != current_record.medreq_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medicationadministration_raw)
			    ...
			    err_section:='medicationadministration_raw-37';    err_schema:='cds2db_in';    err_table:='medicationadministration_raw';
                                                        UPDATE db_log.medicationadministration_raw target_record SET medadm_meta_versionid = current_record.medadm_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND medadm_meta_versionid != current_record.medadm_meta_versionid;
                            UPDATE db_log.medicationadministration_raw target_record SET medadm_meta_lastupdated = current_record.medadm_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND medadm_meta_lastupdated != current_record.medadm_meta_lastupdated;
                            UPDATE db_log.medicationadministration_raw target_record SET medadm_meta_profile = current_record.medadm_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND medadm_meta_profile != current_record.medadm_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medicationstatement_raw)
			    ...
			    err_section:='medicationstatement_raw-37';    err_schema:='cds2db_in';    err_table:='medicationstatement_raw';
                                                        UPDATE db_log.medicationstatement_raw target_record SET medstat_meta_versionid = current_record.medstat_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND medstat_meta_versionid != current_record.medstat_meta_versionid;
                            UPDATE db_log.medicationstatement_raw target_record SET medstat_meta_lastupdated = current_record.medstat_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND medstat_meta_lastupdated != current_record.medstat_meta_lastupdated;
                            UPDATE db_log.medicationstatement_raw target_record SET medstat_meta_profile = current_record.medstat_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND medstat_meta_profile != current_record.medstat_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.observation_raw)
			    ...
			    err_section:='observation_raw-37';    err_schema:='cds2db_in';    err_table:='observation_raw';
                                                        UPDATE db_log.observation_raw target_record SET obs_meta_versionid = current_record.obs_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND obs_meta_versionid != current_record.obs_meta_versionid;
                            UPDATE db_log.observation_raw target_record SET obs_meta_lastupdated = current_record.obs_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND obs_meta_lastupdated != current_record.obs_meta_lastupdated;
                            UPDATE db_log.observation_raw target_record SET obs_meta_profile = current_record.obs_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND obs_meta_profile != current_record.obs_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.diagnosticreport_raw)
			    ...
			    err_section:='diagnosticreport_raw-37';    err_schema:='cds2db_in';    err_table:='diagnosticreport_raw';
                                                        UPDATE db_log.diagnosticreport_raw target_record SET diagrep_meta_versionid = current_record.diagrep_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND diagrep_meta_versionid != current_record.diagrep_meta_versionid;
                            UPDATE db_log.diagnosticreport_raw target_record SET diagrep_meta_lastupdated = current_record.diagrep_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND diagrep_meta_lastupdated != current_record.diagrep_meta_lastupdated;
                            UPDATE db_log.diagnosticreport_raw target_record SET diagrep_meta_profile = current_record.diagrep_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND diagrep_meta_profile != current_record.diagrep_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.servicerequest_raw)
			    ...
			    err_section:='servicerequest_raw-37';    err_schema:='cds2db_in';    err_table:='servicerequest_raw';
                                                        UPDATE db_log.servicerequest_raw target_record SET servreq_meta_versionid = current_record.servreq_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND servreq_meta_versionid != current_record.servreq_meta_versionid;
                            UPDATE db_log.servicerequest_raw target_record SET servreq_meta_lastupdated = current_record.servreq_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND servreq_meta_lastupdated != current_record.servreq_meta_lastupdated;
                            UPDATE db_log.servicerequest_raw target_record SET servreq_meta_profile = current_record.servreq_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND servreq_meta_profile != current_record.servreq_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.procedure_raw)
			    ...
			    err_section:='procedure_raw-37';    err_schema:='cds2db_in';    err_table:='procedure_raw';
                                                        UPDATE db_log.procedure_raw target_record SET proc_meta_versionid = current_record.proc_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND proc_meta_versionid != current_record.proc_meta_versionid;
                            UPDATE db_log.procedure_raw target_record SET proc_meta_lastupdated = current_record.proc_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND proc_meta_lastupdated != current_record.proc_meta_lastupdated;
                            UPDATE db_log.procedure_raw target_record SET proc_meta_profile = current_record.proc_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND proc_meta_profile != current_record.proc_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.consent_raw)
			    ...
			    err_section:='consent_raw-37';    err_schema:='cds2db_in';    err_table:='consent_raw';
                                                        UPDATE db_log.consent_raw target_record SET cons_meta_versionid = current_record.cons_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND cons_meta_versionid != current_record.cons_meta_versionid;
                            UPDATE db_log.consent_raw target_record SET cons_meta_lastupdated = current_record.cons_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND cons_meta_lastupdated != current_record.cons_meta_lastupdated;
                            UPDATE db_log.consent_raw target_record SET cons_meta_profile = current_record.cons_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND cons_meta_profile != current_record.cons_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.location_raw)
			    ...
			    err_section:='location_raw-37';    err_schema:='cds2db_in';    err_table:='location_raw';
                                                        UPDATE db_log.location_raw target_record SET loc_meta_versionid = current_record.loc_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND loc_meta_versionid != current_record.loc_meta_versionid;
                            UPDATE db_log.location_raw target_record SET loc_meta_lastupdated = current_record.loc_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND loc_meta_lastupdated != current_record.loc_meta_lastupdated;
                            UPDATE db_log.location_raw target_record SET loc_meta_profile = current_record.loc_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND loc_meta_profile != current_record.loc_meta_profile;
