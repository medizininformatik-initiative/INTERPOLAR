...
comment on column db2dataprocessor_in.fall_fe.fall_typ_id is 'Datenbank-FK des getypten Falls zur Datenflussverfolgung (Fall: v_fall_all . fall_id) (int)';
...
comment on column db2dataprocessor_in.medikationsanalyse_fe.fall_typ_id is 'Datenbank-FK des Falls (Fall: v_fall_all . fall_id) -> Dataprocessor setzt id: meda_dat in [fall_aufn_dat;fall_ent_dat] (int)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_fall_id is 'Fall-ID zu dem Medikationsanalyse gehört FHIR (Fall:fall_id) (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.meda_typ_id is 'Datenbank-FK der Medikationsanalyse (Medikationsanalyse: medikationsanalyse_fe_id) -> Dataprocessor setzt id: mrp_entd_dat(Tag)=meda_dat(Tag) (int)';
