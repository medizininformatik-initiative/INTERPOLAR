...
comment on column db2dataprocessor_in.fall_fe.fall_header is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.fall_fe.fall_femb is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.fall_fe.fall_femb_2 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_femb_3 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_femb_4 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_femb_5 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_femb_6 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.fall_fe.fall_nieren_insuf_ausmass_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_nieren_insuf_ausmass is '1, Ausmaß unbekannt | 2, 45-59 ml/min/1,73 m2 | 3, 30-44 ml/min/1,73 m2 | 4, 15-29 ml/min/1,73 m2 | 5, < 15 ml/min/1,73 m2 (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_nieren_insuf_dialysev_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_nieren_insuf_dialysev is '1, Hämodialyse | 2, Kont. Hämofiltration | 3, Peritonealdialyse | 4, keineDialyseverfahren (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_leber_insuf is '1, ja | 0, nein | -1, nicht bekanntLeberinsuffizienz (varchar)';
comment on column db2dataprocessor_in.fall_fe.fall_leber_insuf_ausmass_lbl is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_header is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_femb is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_femb_2 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_femb_3 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_femb_4 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_femb_5 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_ma_thueberw_comp_dat_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_ma_thueberw_comp_dat is 'Abgeschlossen am (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_mrp_detekt is 'MRP detektiert? 1, Ja|0, Nein (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_aufwand_zeit is '0, <= 5 min | 1, 6-10 min | 2, 11-20 min | 3, 21-30 min | 4, >30 min | 5, Angabe abgelehntZeitaufwand Medikationsanalyse [Min] (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_aufwand_zeit_and_lbl is 'descriptive item only for frontend (int)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_aufwand_zeit_and is 'wie lange hat die Medikationsanalyse gedauert? Eingabe in Minuten.  (int)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.meda_notiz is 'Notizfeld (varchar)';
comment on column db2dataprocessor_in.medikationsanalyse_fe.medikationsanalyse_complete is 'Frontend Complete-Status (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_header is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_5 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_6 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_7 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_8 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_9 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_10 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_11 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_12 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_wirkstoff is 'Wirkstoff betroffen? (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc1_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc1 is '1. Medikament ATC / Name: (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc2_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc2 is '2. Medikament ATC / Name (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc3_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc3 is '3. Medikament ATC / Name (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc4_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc4 is '4. Medikament ATC / Name (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc5_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_atc5 is '5. Medikament ATC / Name (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_13 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_med_prod is 'Medizinprodukt betroffen? (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_med_prod_sonst_lbl is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_med_prod_sonst is 'Sonstigespräparat (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_dokup_fehler is 'Fehlerbeschreibung  (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_14 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_15 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_16 is 'descriptive item only for frontend (varchar)';
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_17 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_18 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_19 is 'descriptive item only for frontend (varchar)';
...
comment on column db2dataprocessor_in.mrpdokumentation_validierung_fe.mrp_femb_20 is 'descriptive item only for frontend (varchar)';
