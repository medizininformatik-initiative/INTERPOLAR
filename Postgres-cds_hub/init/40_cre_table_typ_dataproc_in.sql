...
-- Create time: 2025-03-03 20:21:35
...
NANANACOMMENT ON COLUMN db2dataprocessor_in.retrolektive_mrp_bewertung_fe.redcap_data_access_group IS 'Funktion als Datensatzfilter nach Stationen (varchar)';
...
NACOMMENT ON COLUMN db2dataprocessor_in.retrolektive_mrp_bewertung_fe.ret_femb_15 IS 'descriptive item only for frontend - femb der Variablen ret_2ndbewertung (varchar)';
