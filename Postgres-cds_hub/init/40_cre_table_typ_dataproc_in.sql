...
-- Create time: 2025-01-29 18:35:52
...
------------------------------------------------------
-- INDEX for data on Tables in Schema "db2dataprocessor_in" --
------------------------------------------------------

-- Index idx_patient_fe_data for Table "patient_fe" in schema "db2dataprocessor_in"
----------------------------------------------------
...
-- Index idx_fall_fe_data for Table "fall_fe" in schema "db2dataprocessor_in"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_medikationsanalyse_fe_data for Table "medikationsanalyse_fe" in schema "db2dataprocessor_in"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_mrpdokumentation_validierung_fe_data for Table "mrpdokumentation_validierung_fe" in schema "db2dataprocessor_in"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_risikofaktor_fe_data for Table "risikofaktor_fe" in schema "db2dataprocessor_in"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
...
-- Index idx_trigger_fe_data for Table "trigger_fe" in schema "db2dataprocessor_in"
----------------------------------------------------
-- Funktioniert nicht - weil nicht mehr als 32 Spalten Möglich
