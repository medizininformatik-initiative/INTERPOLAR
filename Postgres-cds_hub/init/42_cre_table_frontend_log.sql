...
-- Create time: 2025-03-03 20:21:41
...
NACOMMENT ON COLUMN db_log.retrolektive_mrp_bewertung_fe.ret_femb_15 IS 'descriptive item only for frontend - femb der Variablen ret_2ndbewertung (varchar)';
