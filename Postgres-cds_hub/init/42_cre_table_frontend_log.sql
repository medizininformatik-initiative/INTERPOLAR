...
comment on column db_log.medikationsanalyse_fe.meda_risiko_pat_info__1 is 'descriptive item only for frontend (varchar)';
...
comment on column db_log.mrpdokumentation_validierung_fe.mrp_pi_info__1 is 'descriptive item only for frontend (varchar)';
comment on column db_log.mrpdokumentation_validierung_fe.mrp_mf_info is 'descriptive item only for frontend (varchar)';
comment on column db_log.mrpdokumentation_validierung_fe.mrp_mf_info__1 is 'descriptive item only for frontend (varchar)';
...
comment on column db_log.mrpdokumentation_validierung_fe.mrp_merp_info__1 is 'descriptive item only for frontend (varchar)';
