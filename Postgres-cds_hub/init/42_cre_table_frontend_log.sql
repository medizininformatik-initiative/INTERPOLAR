...
comment on column db_log.patient_fe.patient_fe_id is 'Patienten-identifier Datenbank für synchronisation (varchar)';
...
comment on column db_log.fall_fe.fall_fe_id is 'Datenbank-FK des getypten Falls zur Datenflussverfolgung (Fall: v_fall_all . fall_id) (int)';
