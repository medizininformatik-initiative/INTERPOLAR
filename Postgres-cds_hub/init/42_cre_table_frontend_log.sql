...
-- Create time: 2024-09-02 13:42:36
...
comment on column db_log.fall_fe.fall_bettplatz is 'Bettplatz wie vom DIZ Definiert (varchar)';
...
comment on column db_log.mrpdokumentation_validierung_fe.mrpdokumentation_validierung_complete is 'Frontend Complete-Status, wenn ein Pflichtitem fehlt Status bei Import wieder auf Incomplete setzen  (varchar)';
