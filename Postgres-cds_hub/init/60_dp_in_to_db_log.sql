...
-- Create time: 2024-12-03 11:02:14
...
/*
                    SELECT db.error_log(
                        ...
                        'db.copy_fe_dp_in_to_db_log - '||err_table, -- Objekt (Tabelle, Funktion, etc.)
...
*/
    INSERT INTO db_config.db_error_log (err_schema, err_objekt, err_line,err_msg, err_user, err_variables)  VALUES (err_schema,'db.copy_fe_dp_in_to_db_log()',err_section, SQLSTATE||' - '||SQLERRM, current_user, err_table||' last pid:'||err_pid);
