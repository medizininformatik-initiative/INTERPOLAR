...
-- Create time: 2025-04-02 15:41:20
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.encounter)
			    ...
			    err_section:='encounter-37';    err_schema:='cds2db_in';    err_table:='encounter';
                                                        UPDATE db_log.encounter target_record SET enc_meta_versionid = current_record.enc_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND enc_meta_versionid != current_record.enc_meta_versionid;
                            UPDATE db_log.encounter target_record SET enc_meta_lastupdated = current_record.enc_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND enc_meta_lastupdated != current_record.enc_meta_lastupdated;
                            UPDATE db_log.encounter target_record SET enc_meta_profile = current_record.enc_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND enc_meta_profile != current_record.enc_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.patient)
			    ...
			    err_section:='patient-37';    err_schema:='cds2db_in';    err_table:='patient';
                                                        UPDATE db_log.patient target_record SET pat_meta_versionid = current_record.pat_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND pat_meta_versionid != current_record.pat_meta_versionid;
                            UPDATE db_log.patient target_record SET pat_meta_lastupdated = current_record.pat_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND pat_meta_lastupdated != current_record.pat_meta_lastupdated;
                            UPDATE db_log.patient target_record SET pat_meta_profile = current_record.pat_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND pat_meta_profile != current_record.pat_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.condition)
			    ...
			    err_section:='condition-37';    err_schema:='cds2db_in';    err_table:='condition';
                                                        UPDATE db_log.condition target_record SET con_meta_versionid = current_record.con_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND con_meta_versionid != current_record.con_meta_versionid;
                            UPDATE db_log.condition target_record SET con_meta_lastupdated = current_record.con_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND con_meta_lastupdated != current_record.con_meta_lastupdated;
                            UPDATE db_log.condition target_record SET con_meta_profile = current_record.con_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND con_meta_profile != current_record.con_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medication)
			    ...
			    err_section:='medication-37';    err_schema:='cds2db_in';    err_table:='medication';
                                                        UPDATE db_log.medication target_record SET med_meta_versionid = current_record.med_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND med_meta_versionid != current_record.med_meta_versionid;
                            UPDATE db_log.medication target_record SET med_meta_lastupdated = current_record.med_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND med_meta_lastupdated != current_record.med_meta_lastupdated;
                            UPDATE db_log.medication target_record SET med_meta_profile = current_record.med_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND med_meta_profile != current_record.med_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medicationrequest)
			    ...
			    err_section:='medicationrequest-37';    err_schema:='cds2db_in';    err_table:='medicationrequest';
                                                        UPDATE db_log.medicationrequest target_record SET medreq_meta_versionid = current_record.medreq_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND medreq_meta_versionid != current_record.medreq_meta_versionid;
                            UPDATE db_log.medicationrequest target_record SET medreq_meta_lastupdated = current_record.medreq_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND medreq_meta_lastupdated != current_record.medreq_meta_lastupdated;
                            UPDATE db_log.medicationrequest target_record SET medreq_meta_profile = current_record.medreq_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND medreq_meta_profile != current_record.medreq_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medicationadministration)
			    ...
			    err_section:='medicationadministration-37';    err_schema:='cds2db_in';    err_table:='medicationadministration';
                                                        UPDATE db_log.medicationadministration target_record SET medadm_meta_versionid = current_record.medadm_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND medadm_meta_versionid != current_record.medadm_meta_versionid;
                            UPDATE db_log.medicationadministration target_record SET medadm_meta_lastupdated = current_record.medadm_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND medadm_meta_lastupdated != current_record.medadm_meta_lastupdated;
                            UPDATE db_log.medicationadministration target_record SET medadm_meta_profile = current_record.medadm_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND medadm_meta_profile != current_record.medadm_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.medicationstatement)
			    ...
			    err_section:='medicationstatement-37';    err_schema:='cds2db_in';    err_table:='medicationstatement';
                                                        UPDATE db_log.medicationstatement target_record SET medstat_meta_versionid = current_record.medstat_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND medstat_meta_versionid != current_record.medstat_meta_versionid;
                            UPDATE db_log.medicationstatement target_record SET medstat_meta_lastupdated = current_record.medstat_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND medstat_meta_lastupdated != current_record.medstat_meta_lastupdated;
                            UPDATE db_log.medicationstatement target_record SET medstat_meta_profile = current_record.medstat_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND medstat_meta_profile != current_record.medstat_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.observation)
			    ...
			    err_section:='observation-37';    err_schema:='cds2db_in';    err_table:='observation';
                                                        UPDATE db_log.observation target_record SET obs_meta_versionid = current_record.obs_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND obs_meta_versionid != current_record.obs_meta_versionid;
                            UPDATE db_log.observation target_record SET obs_meta_lastupdated = current_record.obs_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND obs_meta_lastupdated != current_record.obs_meta_lastupdated;
                            UPDATE db_log.observation target_record SET obs_meta_profile = current_record.obs_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND obs_meta_profile != current_record.obs_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.diagnosticreport)
			    ...
			    err_section:='diagnosticreport-37';    err_schema:='cds2db_in';    err_table:='diagnosticreport';
                                                        UPDATE db_log.diagnosticreport target_record SET diagrep_meta_versionid = current_record.diagrep_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND diagrep_meta_versionid != current_record.diagrep_meta_versionid;
                            UPDATE db_log.diagnosticreport target_record SET diagrep_meta_lastupdated = current_record.diagrep_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND diagrep_meta_lastupdated != current_record.diagrep_meta_lastupdated;
                            UPDATE db_log.diagnosticreport target_record SET diagrep_meta_profile = current_record.diagrep_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND diagrep_meta_profile != current_record.diagrep_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.servicerequest)
			    ...
			    err_section:='servicerequest-37';    err_schema:='cds2db_in';    err_table:='servicerequest';
                                                        UPDATE db_log.servicerequest target_record SET servreq_meta_versionid = current_record.servreq_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND servreq_meta_versionid != current_record.servreq_meta_versionid;
                            UPDATE db_log.servicerequest target_record SET servreq_meta_lastupdated = current_record.servreq_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND servreq_meta_lastupdated != current_record.servreq_meta_lastupdated;
                            UPDATE db_log.servicerequest target_record SET servreq_meta_profile = current_record.servreq_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND servreq_meta_profile != current_record.servreq_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.procedure)
			    ...
			    err_section:='procedure-37';    err_schema:='cds2db_in';    err_table:='procedure';
                                                        UPDATE db_log.procedure target_record SET proc_meta_versionid = current_record.proc_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND proc_meta_versionid != current_record.proc_meta_versionid;
                            UPDATE db_log.procedure target_record SET proc_meta_lastupdated = current_record.proc_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND proc_meta_lastupdated != current_record.proc_meta_lastupdated;
                            UPDATE db_log.procedure target_record SET proc_meta_profile = current_record.proc_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND proc_meta_profile != current_record.proc_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.consent)
			    ...
			    err_section:='consent-37';    err_schema:='cds2db_in';    err_table:='consent';
                                                        UPDATE db_log.consent target_record SET cons_meta_versionid = current_record.cons_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND cons_meta_versionid != current_record.cons_meta_versionid;
                            UPDATE db_log.consent target_record SET cons_meta_lastupdated = current_record.cons_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND cons_meta_lastupdated != current_record.cons_meta_lastupdated;
                            UPDATE db_log.consent target_record SET cons_meta_profile = current_record.cons_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND cons_meta_profile != current_record.cons_meta_profile;
        ...
        IF data_count_all>0 THEN -- Complete execution is only necessary if new data records are available - otherwise no database access is necessary
            ...
            FOR current_record IN (SELECT * FROM cds2db_in.location)
			    ...
			    err_section:='location-37';    err_schema:='cds2db_in';    err_table:='location';
                                                        UPDATE db_log.location target_record SET loc_meta_versionid = current_record.loc_meta_versionid WHERE target_record.hash_index_col = current_record.hash_index_col AND loc_meta_versionid != current_record.loc_meta_versionid;
                            UPDATE db_log.location target_record SET loc_meta_lastupdated = current_record.loc_meta_lastupdated WHERE target_record.hash_index_col = current_record.hash_index_col AND loc_meta_lastupdated != current_record.loc_meta_lastupdated;
                            UPDATE db_log.location target_record SET loc_meta_profile = current_record.loc_meta_profile WHERE target_record.hash_index_col = current_record.hash_index_col AND loc_meta_profile != current_record.loc_meta_profile;
