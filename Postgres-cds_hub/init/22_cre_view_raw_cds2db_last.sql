...
CREATE OR REPLACE VIEW cds2db_out.v_encounter_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_patient_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_condition_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medication_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medicationrequest_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medicationadministration_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medicationstatement_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_observation_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_diagnosticreport_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_servicerequest_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_procedure_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_consent_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_location_lraw AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_pids_per_ward_lraw AS (
...
GRANT SELECT ON TABLE cds2db_out.v_encounter_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_patient_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_condition_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medication_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medicationrequest_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medicationadministration_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medicationstatement_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_observation_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_diagnosticreport_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_servicerequest_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_procedure_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_consent_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_location_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_pids_per_ward_lraw TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;
