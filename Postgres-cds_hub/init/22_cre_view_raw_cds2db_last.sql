...
-- Create time: 2024-12-05 10:04:11
-- TABLE_DESCRIPTION:  ./R-cds2db/cds2db/inst/extdata/Table_Description.xlsx[table_description]
-- SCRIPTNAME:  22_cre_view_raw_cds2db_last.sql
-- TEMPLATE:  template_cre_view4.sql
-- OWNER_USER:  cds2db_user
-- OWNER_SCHEMA:  cds2db_out
-- TAGS:  
-- TABLE_PREFIX:  v_
-- TABLE_POSTFIX:  _raw_last
-- RIGHTS:  SELECT
...
--Create SQL View for latest raw-Datasets for schema cds2db_out

CREATE OR REPLACE VIEW cds2db_out.v_encounter_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_patient_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_condition_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medication_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medicationrequest_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medicationadministration_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_medicationstatement_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_observation_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_diagnosticreport_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_servicerequest_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_procedure_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_consent_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_location_raw_last AS (
...
CREATE OR REPLACE VIEW cds2db_out.v_pids_per_ward_raw_last AS (
...
GRANT SELECT ON TABLE cds2db_out.v_encounter_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_patient_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_condition_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medication_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medicationrequest_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medicationadministration_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_medicationstatement_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_observation_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_diagnosticreport_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_servicerequest_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_procedure_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_consent_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_location_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;

GRANT SELECT ON TABLE cds2db_out.v_pids_per_ward_raw_last TO cds2db_user;
GRANT USAGE ON SCHEMA cds2db_out TO cds2db_user;
