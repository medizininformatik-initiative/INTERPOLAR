...
-- Create time: 2025-06-01 22:53:42
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_patient_fe_input_dt',1,63)
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_patient_fe_input_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_input_dt ON db2dataprocessor_in.patient_fe USING brin (input_datetime);
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_patient_fe_input_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_patient_fe_input_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_input_pnr ON db2dataprocessor_in.patient_fe USING brin (input_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_input_pnr ON db2dataprocessor_in.patient_fe USING brin (input_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_patient_fe_last_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_patient_fe_last_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_last_dt ON db2dataprocessor_in.patient_fe USING brin (last_check_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_last_dt ON db2dataprocessor_in.patient_fe USING brin (last_check_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_patient_fe_last_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_patient_fe_last_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_last_pnr ON db2dataprocessor_in.patient_fe USING brin (last_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_last_pnr ON db2dataprocessor_in.patient_fe USING brin (last_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_patient_fe_hash',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_patient_fe_hash;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_hash ON db2dataprocessor_in.patient_fe USING btree (hash_index_col);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_patient_fe_hash ON db2dataprocessor_in.patient_fe USING btree (hash_index_col);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_fall_fe_input_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_fall_fe_input_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_input_dt ON db2dataprocessor_in.fall_fe USING brin (input_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_input_dt ON db2dataprocessor_in.fall_fe USING brin (input_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_fall_fe_input_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_fall_fe_input_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_input_pnr ON db2dataprocessor_in.fall_fe USING brin (input_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_input_pnr ON db2dataprocessor_in.fall_fe USING brin (input_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_fall_fe_last_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_fall_fe_last_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_last_dt ON db2dataprocessor_in.fall_fe USING brin (last_check_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_last_dt ON db2dataprocessor_in.fall_fe USING brin (last_check_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_fall_fe_last_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_fall_fe_last_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_last_pnr ON db2dataprocessor_in.fall_fe USING brin (last_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_last_pnr ON db2dataprocessor_in.fall_fe USING brin (last_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_fall_fe_hash',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_fall_fe_hash;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_hash ON db2dataprocessor_in.fall_fe USING btree (hash_index_col);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_fall_fe_hash ON db2dataprocessor_in.fall_fe USING btree (hash_index_col);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt ON db2dataprocessor_in.medikationsanalyse_fe USING brin (input_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_input_dt ON db2dataprocessor_in.medikationsanalyse_fe USING brin (input_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_medikationsanalyse_fe_input_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_medikationsanalyse_fe_input_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_input_pnr ON db2dataprocessor_in.medikationsanalyse_fe USING brin (input_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_input_pnr ON db2dataprocessor_in.medikationsanalyse_fe USING brin (input_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_medikationsanalyse_fe_last_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_medikationsanalyse_fe_last_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_last_dt ON db2dataprocessor_in.medikationsanalyse_fe USING brin (last_check_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_last_dt ON db2dataprocessor_in.medikationsanalyse_fe USING brin (last_check_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_medikationsanalyse_fe_last_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_medikationsanalyse_fe_last_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_last_pnr ON db2dataprocessor_in.medikationsanalyse_fe USING brin (last_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_last_pnr ON db2dataprocessor_in.medikationsanalyse_fe USING brin (last_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_medikationsanalyse_fe_hash',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_medikationsanalyse_fe_hash;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_hash ON db2dataprocessor_in.medikationsanalyse_fe USING btree (hash_index_col);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_medikationsanalyse_fe_hash ON db2dataprocessor_in.medikationsanalyse_fe USING btree (hash_index_col);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (input_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_dt ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (input_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_pnr ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (input_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_input_pnr ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (input_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_dt ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (last_check_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_dt ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (last_check_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_pnr ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (last_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_last_pnr ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING brin (last_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_hash',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_hash;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_hash ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING btree (hash_index_col);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_mrpdokumentation_validierung_fe_hash ON db2dataprocessor_in.mrpdokumentation_validierung_fe USING btree (hash_index_col);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (input_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_dt ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (input_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_pnr ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (input_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_input_pnr ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (input_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_dt ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (last_check_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_dt ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (last_check_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_pnr ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (last_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_last_pnr ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING brin (last_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_hash',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_hash;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_hash ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING btree (hash_index_col);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_retrolektive_mrpbewertung_fe_hash ON db2dataprocessor_in.retrolektive_mrpbewertung_fe USING btree (hash_index_col);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_risikofaktor_fe_input_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_risikofaktor_fe_input_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_input_dt ON db2dataprocessor_in.risikofaktor_fe USING brin (input_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_input_dt ON db2dataprocessor_in.risikofaktor_fe USING brin (input_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_risikofaktor_fe_input_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_risikofaktor_fe_input_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_input_pnr ON db2dataprocessor_in.risikofaktor_fe USING brin (input_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_input_pnr ON db2dataprocessor_in.risikofaktor_fe USING brin (input_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_risikofaktor_fe_last_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_risikofaktor_fe_last_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_last_dt ON db2dataprocessor_in.risikofaktor_fe USING brin (last_check_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_last_dt ON db2dataprocessor_in.risikofaktor_fe USING brin (last_check_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_risikofaktor_fe_last_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_risikofaktor_fe_last_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_last_pnr ON db2dataprocessor_in.risikofaktor_fe USING brin (last_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_last_pnr ON db2dataprocessor_in.risikofaktor_fe USING brin (last_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_risikofaktor_fe_hash',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_risikofaktor_fe_hash;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_hash ON db2dataprocessor_in.risikofaktor_fe USING btree (hash_index_col);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_risikofaktor_fe_hash ON db2dataprocessor_in.risikofaktor_fe USING btree (hash_index_col);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_trigger_fe_input_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_trigger_fe_input_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_input_dt ON db2dataprocessor_in.trigger_fe USING brin (input_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_input_dt ON db2dataprocessor_in.trigger_fe USING brin (input_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_trigger_fe_input_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_trigger_fe_input_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_input_pnr ON db2dataprocessor_in.trigger_fe USING brin (input_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_input_pnr ON db2dataprocessor_in.trigger_fe USING brin (input_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_trigger_fe_last_dt',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_trigger_fe_last_dt;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_last_dt ON db2dataprocessor_in.trigger_fe USING brin (last_check_datetime);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_last_dt ON db2dataprocessor_in.trigger_fe USING brin (last_check_datetime);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_trigger_fe_last_pnr',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_trigger_fe_last_pnr;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_last_pnr ON db2dataprocessor_in.trigger_fe USING brin (last_processing_nr);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_last_pnr ON db2dataprocessor_in.trigger_fe USING brin (last_processing_nr);
    END IF; -- INDEX available"%>
...
IF EXISTS ( -- target column
    ...
    IF EXISTS ( -- INDEX available
        SELECT 1 FROM pg_indexes where substr(indexname,1,63)=substr('idx_db2dataprocessor_in_trigger_fe_hash',1,63)
    ) THEN -- check current status
        IF EXISTS ( -- INDEX nicht auf akuellen Stand
            SELECT 1 FROM pg_indexes WHERE schemaname NOT IN ('pg_catalog', 'information_schema')
		...
		DROP INDEX CONCURRENTLY IF EXISTS idx_db2dataprocessor_in_trigger_fe_hash;
	        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_hash ON db2dataprocessor_in.trigger_fe USING btree (hash_index_col);
        END IF; -- check current status"%>
    ELSE -- (easy) Create new
        CREATE INDEX CONCURRENTLY idx_db2dataprocessor_in_trigger_fe_hash ON db2dataprocessor_in.trigger_fe USING btree (hash_index_col);
    END IF; -- INDEX available"%>
