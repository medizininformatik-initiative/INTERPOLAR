...
-- Create time: 2025-05-20 19:36:27
...
-- Hash column for comparison on data-bearing columns -------------------------------------------
        IF EXISTS ( -- column exists
            SELECT 1 FROM information_schema.columns 
            WHERE table_schema = 'db2dataprocessor_in' AND table_name = 'patient_fe' AND column_name = 'hash_index_col'
        ) THEN
...
-- Hash column for comparison on data-bearing columns -------------------------------------------
        IF EXISTS ( -- column exists
            SELECT 1 FROM information_schema.columns 
            WHERE table_schema = 'db2dataprocessor_in' AND table_name = 'fall_fe' AND column_name = 'hash_index_col'
        ) THEN
            IF NOT EXISTS ( -- column exists
...
-- Hash column for comparison on data-bearing columns -------------------------------------------
        IF EXISTS ( -- column exists
            SELECT 1 FROM information_schema.columns 
            WHERE table_schema = 'db2dataprocessor_in' AND table_name = 'medikationsanalyse_fe' AND column_name = 'hash_index_col'
        ) THEN
            IF NOT EXISTS ( -- column exists
...
-- Hash column for comparison on data-bearing columns -------------------------------------------
        IF EXISTS ( -- column exists
            SELECT 1 FROM information_schema.columns 
            WHERE table_schema = 'db2dataprocessor_in' AND table_name = 'mrpdokumentation_validierung_fe' AND column_name = 'hash_index_col'
        ) THEN
            IF NOT EXISTS ( -- column exists
...
-- Hash column for comparison on data-bearing columns -------------------------------------------
        IF EXISTS ( -- column exists
            SELECT 1 FROM information_schema.columns 
            WHERE table_schema = 'db2dataprocessor_in' AND table_name = 'retrolektive_mrpbewertung_fe' AND column_name = 'hash_index_col'
        ) THEN
            IF NOT EXISTS ( -- column exists
...
-- Hash column for comparison on data-bearing columns -------------------------------------------
        IF EXISTS ( -- column exists
            SELECT 1 FROM information_schema.columns 
            WHERE table_schema = 'db2dataprocessor_in' AND table_name = 'risikofaktor_fe' AND column_name = 'hash_index_col'
        ) THEN
            IF NOT EXISTS ( -- column exists
...
-- Hash column for comparison on data-bearing columns -------------------------------------------
        IF EXISTS ( -- column exists
            SELECT 1 FROM information_schema.columns 
            WHERE table_schema = 'db2dataprocessor_in' AND table_name = 'trigger_fe' AND column_name = 'hash_index_col'
        ) THEN
            IF NOT EXISTS ( -- column exists
