...
-- Create time: 2025-04-18 01:01:35
...
-- Data-leading columns -------------------------------------------------------------------------
        ...
        IF NOT EXISTS ( -- column not exists (mrp_merp_info___1)
            ...
            ALTER TABLE db2dataprocessor_in.mrpdokumentation_validierung_fe ADD mrp_merp_info___1 varchar;   -- 1 - NCC MERP Index (varchar)
...
-- Data-leading columns -------------------------------------------------------------------------
        ...
        IF NOT EXISTS ( -- column not exists (ret_id)
            ...
            ALTER TABLE db2dataprocessor_in.retrolektive_mrpbewertung_fe ADD ret_id varchar;   -- Retrolektive MRP-ID (REDCap) Fall-ID Encounter-Identifier (KIS) mit Instanz der aktuellen Medikationsanalyse und der Instanz des aktuellen MRP aggregiert (varchar)
        ...
        IF NOT EXISTS ( -- column not exists (ret_gewiss_grund_abl_klin_neg___1)
            ...
            ALTER TABLE db2dataprocessor_in.retrolektive_mrpbewertung_fe ADD ret_gewiss_grund_abl_klin_neg___1 varchar;   -- 1 - Dieses MRP halte ich FÜR KEINEN Patienten auf dieser Station für KLINISCH RELEVANT (varchar)
...
COMMENT ON COLUMN db2dataprocessor_in.retrolektive_mrpbewertung_fe.ret_id IS 'Retrolektive MRP-ID (REDCap) Fall-ID Encounter-Identifier (KIS) mit Instanz der aktuellen Medikationsanalyse und der Instanz des aktuellen MRP aggregiert (varchar)';
