...
-   filtert Fälle (alle Ebenen) heraus, deren `enc_identifier_system` nicht dem erwarteten Fall-FHIR-Identifikatorsystem entsprechen (sofern als `MEDICAL_CASE_ID_ENCOUNTER_FHIR_IDENTIFIER_SYSTEM` definiert).
