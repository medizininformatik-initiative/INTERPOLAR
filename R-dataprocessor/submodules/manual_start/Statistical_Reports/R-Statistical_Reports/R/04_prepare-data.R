...
#' @param fe_summary_data A data frame of front-end documentation data, typically generated by `prepareFeSummaryData()`.
#'
#' @return A data frame where `F1_data` is enriched with selected variables from `fe_summary_data`,
...
#' @export
addFeDataToF1data <- function(F1_data, fe_summary_data) {

  F1_data_with_fe <- F1_data |>
    dplyr::left_join(fe_summary_data |>
