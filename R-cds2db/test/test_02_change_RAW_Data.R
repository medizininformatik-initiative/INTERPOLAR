...
if (exists("DEBUG_DAY")) {
  ...
  runCodeForDebugDay(1, {
    ...
    addObservationWithRanges("UKB-0001_18", "1742-6", day_offset = -0.5 + (i * 0.014), value = 60.05 + i, unit = "mg/dL", reference_ranges =
                               list(
                                 ...
                                 createReferenceRange(referencerange_low_value = 0.060, referencerange_high_value = 0.10, referencerange_low_code = "g/dl", referencerange_high_code = "g/dl", referencerange_type_code = "recommended")
                               )) # +

    addDrugs("UKB-0001_19", c("J01MA14", "C03DA02"))
    addObservationWithRanges("UKB-0001_19", "1742-6", day_offset = -0.5 + (i * 0.014), value = 60.05 + i, unit = "mg/dL", reference_ranges =
                               list(
                                 createReferenceRange(referencerange_low_value = 0.005, referencerange_high_value = 0.01, referencerange_low_code = "g/dl", referencerange_high_code = "g/dl"),
                                 createReferenceRange(referencerange_low_value = 0.060, referencerange_high_value = 0.10, referencerange_low_code = "g/dl", referencerange_high_code = "g/dl", referencerange_type_code = "recommended")
                               )) # +
    ...
    addObservationWithRanges("UKB-0001_19", "1742-6", day_offset = -0.5 + (i * 0.014), value = 60.05 + i, unit = "mg/dL", reference_ranges =
                               list(
                                 createReferenceRange(referencerange_low_value = 0.005, referencerange_high_value = 0.01, referencerange_low_code = "g/dl", referencerange_high_code = "g/dl"),
                                 createReferenceRange(referencerange_low_value = 0.060, referencerange_high_value = 0.10, referencerange_low_code = "g/dl", referencerange_high_code = "g/dl")
                               )) # +
    ...
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -0.5 + (i * 0.01), value = 60 + i, unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10) # +
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 0 (vor Aufnahme) (Wert immer > 5 * ULN)
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -1.5 + (i * 0.01), value = 60.1 + i, unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10) # +
    #
    ...
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -0.5 + (i * 0.01), value = 0.6 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    ...
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -1.5 + (i * 0.01), value = 0.61 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #
    #   # sekundärer 1744-2 für primären 1742-6 (sonst identisch, wie die darüber nur ganz leicht zeitlich danach)
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 1 (Wert immer > 5 * ULN) aber anderer Reference Range als bei den ersten 10
    #   addObservation("UKB-0001_18", "1744-2", day_offset = -0.5 + (i * 0.011), value = 0.62 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 0 (vor Aufnahme) (Wert immer > 5 * ULN) aber anderer Reference Range als bei den ersten 10
    #   addObservation("UKB-0001_18", "1744-2", day_offset = -1.5 + (i * 0.011), value = 0.63 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #
    #
    #   # 5 Obs ohne ULN Überschreitung alle Zeitpunkte an Tag 1 (Wert immer < 5 * ULN)
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -0.5 + (i * 0.015), value = 5 + (i * 0.1), unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10) # -
    #   # 5 Obs mit ULN Überschreitung für alle Zeitpunkte um die Gültigkeitsdauer der Diagnose von max. 30 Tagen (Wert immer > 5 * ULN)
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -31.5 + (i * 0.01), value = 0.64 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # -
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -30.5 + (i * 0.01), value = 0.65 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # -
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -29.5 + (i * 0.01), value = 0.66 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #   addObservation("UKB-0001_18", "1742-6", day_offset = -28.5 + (i * 0.01), value = 0.67 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #
    #   # 5 Obs mit LLN Unterschreitung alle Zeitpunkte an Tag 1 (Wert immer < LLN) anderer LOINC
    #   addObservation("UKB-0001_18", "2951-2", day_offset = -0.5 + (i * 0.01), value = 5 - (i * 0.001), unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10)
    #
    #   #Über- und Unterschreitung gleichzeitg mit demselben LOINC
    #   # A02AH01 11558-4 > ULN
    #   # A12BA01 11558-4 < LLN
    #   addDrugs("UKB-0001_18", c("A02AH01", "A12BA01"))
    #   addObservation("UKB-0001_18", "11558-4", day_offset = -0.5 + (i * 0.01), value = 60 + i, unit = "mg/dL", referencerange_low_value = 10, referencerange_high_value = 20) # +
    # }

    # for (i in 1:1) {
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 1  (Wert immer > 5 * ULN)
    #   addObservation("UKB-0001_6", "1742-6", day_offset = -0.5 + (i * 0.001), value = 60.01 + i, unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10) # +
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 1  (Wert immer > 5 * ULN)
    #   addObservation("UKB-0001_6", "1742-6", day_offset = -0.5 + (i * 0.003), value = 60.02 + i, unit = "mg/dL", referencerange_low_value = 0.005, referencerange_high_value = 0.01, referencerange_low_code = "g/dl", referencerange_high_code = "g/dl") # +
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 1  (Wert immer > 5 * ULN)
    #   addObservation("UKB-0001_6", "1743-4", day_offset = -0.5 + (i * 0.008), value = 60.03 + i, unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10) # +
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 1  (Wert immer > 5 * ULN)
    #   addObservation("UKB-0001_6", "1743-4", day_offset = -0.5 + (i * 0.012), value = 60.04 + i, unit = "mg/dL", referencerange_low_value = 0.005, referencerange_high_value = 0.01, referencerange_low_code = "g/dl", referencerange_high_code = "g/dl") # +
    #   # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 1  (Wert immer > 5 * ULN)
    #
    ...
    #
    #   # # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 0 (vor Aufnahme) (Wert immer > 5 * ULN)
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -1.5 + (i * 0.01), value = 60.1 + i, unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10) # +
    #   #
    #   # # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 1 (Wert immer > 5 * ULN) aber anderer Reference Range als bei den ersten 10
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -0.5 + (i * 0.01), value = 0.6 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #   # # 5 Obs mit ULN Überschreitung alle Zeitpunkte an Tag 0 (vor Aufnahme) (Wert immer > 5 * ULN) aber anderer Reference Range als bei den ersten 10
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -1.5 + (i * 0.01), value = 0.61 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #   #
    #   #
    #   # # 5 Obs ohne ULN Überschreitung alle Zeitpunkte an Tag 1 (Wert immer < 5 * ULN)
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -0.5 + (i * 0.015), value = 5 + (i * 0.1), unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10) # -
    #   # # 5 Obs mit ULN Überschreitung für alle Zeitpunkte um die Gültigkeitsdauer der Diagnose von max. 30 Tagen (Wert immer > 5 * ULN)
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -28.5 + (i * 0.01), value = 0.62 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -29.5 + (i * 0.01), value = 0.63 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -30.5 + (i * 0.01), value = 0.64 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # -
    #   # addObservation("UKB-0001_6", "1742-6", day_offset = -31.5 + (i * 0.01), value = 0.65 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # -
    #   #
    #   # # 5 Obs mit ULN Überschreitung für sekundären LOINC mit Gültigkeitsdauer der Diagnose von max. 30 Tagen (Wert immer > 5 * ULN)
    #   # addObservation("UKB-0001_6", "1743-4", day_offset = -25 + (i * 0.01), value = 0.66 + (i * 0.001), unit = "mg/mL", referencerange_low_value = 0.03, referencerange_high_value = 0.11) # +
    #   #
    #   # # 5 Obs mit LLN Unterschreitung alle Zeitpunkte an Tag 1 (Wert immer < LLN) anderer LOINC
    #   # addObservation("UKB-0001_6", "2951-2", day_offset = -0.5 + (i * 0.01), value = 5 - (i * 0.001), unit = "mg/dL", referencerange_low_value = 5, referencerange_high_value = 10)
    #   #
    #   # #Über- und Unterschreitung gleichzeitg mit demselben LOINC
    #   # # A02AH01 11558-4 > ULN
    #   # # A12BA01 11558-4 < LLN
    #   # addDrugs("UKB-0001_6", c("A02AH01", "A12BA01"))
    #   # addObservation("UKB-0001_6", "11558-4", day_offset = -0.5 + (i * 0.01), value = 60 + i, unit = "mg/dL", referencerange_low_value = 10, referencerange_high_value = 20) # +
    #   # addObservation("UKB-0001_6", "11558-4", day_offset = -0.6 + (i * 0.01), value = i, unit = "mg/dL", referencerange_low_value = 10, referencerange_high_value = 20) # +
    # }
