if (exists("DEBUG_DAY")) {
  ...
  if (DEBUG_DAY == 1) {
    ...
    etlutils::dbReset()
    pats <- namedListByValue("UKB-0001", "UKB-0002", "UKB-0003", "UKB-0004") # present at day 1
  } else{
    if (DEBUG_DAY == 2) {
      pats <- c("UKB-0001", "UKB-0002", "UKB-0003", "UKB-0004", "UKB-0005") # still there
    } else if (DEBUG_DAY == 3) {
      pats <- c("UKB-0001", "UKB-0002", "UKB-0005") # still there
    } else if (DEBUG_DAY == 4) {
    }
  ...
  if (DEBUG_DAY == 1) {
    ...
    # Patient 3: not in the data anymore (left the ward) and the existing
    ...
    # Patient 4: not in the data anymore (left the ward) and the existing
    # diagnosis from the loaded RAW data is not removed
    ...
    # Patient 5: new patient, set all encounter to "in-progress", delete end date and diagnoses
    # and set the encounter last updated date to the current date with a small offset
