...
#'
getDatabaseReadConnection <- function() getDatabaseConnection(DB_DB2FRONTEND_SCHEMA_OUT)
...
#'
getDatabaseWriteConnection <- function() getDatabaseConnection(DB_DB2FRONTEND_SCHEMA_IN)
