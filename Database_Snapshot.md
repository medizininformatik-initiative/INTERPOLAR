...
Vor dem Einspielen des Snapshot-Dumps prüft das Script die Pseudonymisierungsregeln sowie die Mapping-Datei, benötigte Sheets und Pflichtspalten, leere Werte und doppelte Keys. Bei einem Fehler nennt die Ausgabe die erforderliche Korrektur und verweist auf `outputLocal/snapshot_pseudonymization_preflight*/reports/pseudonymization_rule_review.xlsx`. Da konkrete Mapping-Keys von den Daten im Snapshot abhängen, können fehlende Keys erst während der anschließenden Tabellenverarbeitung erkannt werden.
