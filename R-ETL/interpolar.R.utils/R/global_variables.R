...
utils::globalVariables(c("BUNDLES_AT_ONCE", "ENC_REQ_PER", "ENC_REQ_TYPE", "FHIR_ENDPOINT", "MAX_CORES", "MAX_ENCOUNTER_BUNDLES",
                         "DELAY_REQ", "FHIR_USERNAME", "FHIR_PASSWORD", "COUNT_PER_BUNDLE", "FHIR_TOKEN", "FHIR_TOKEN_REFRESH_PASSWORD",
